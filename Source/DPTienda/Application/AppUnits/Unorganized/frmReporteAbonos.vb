...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ExplorerBar1.Size = New System.Drawing.Size(536, 322)
        ...
        Me.Label3.Location = New System.Drawing.Point(296, 304)
        ...
        Me.Label4.Location = New System.Drawing.Point(272, 304)
        ...
        Me.Label22.Location = New System.Drawing.Point(32, 304)
        ...
        Me.Label21.Location = New System.Drawing.Point(16, 304)
        ...
        Me.Label16.Location = New System.Drawing.Point(176, 304)
        ...
        Me.Label13.Location = New System.Drawing.Point(152, 304)
        ...
        Me.KeyPreview = True
        Me.MaximumSize = New System.Drawing.Size(552, 360)
        Me.MinimumSize = New System.Drawing.Size(552, 360)
        Me.Name = "frmReporteAbonos"
        Me.Text = "Reporte de Abonos o Anticipos"
...
#End Region
    ...
    Private isExcelOpen As Boolean = False
    ...
    Public Sub ActionPreview()
        Try
            If Not Me.dsTraspasos Is Nothing Then
                ...
                Dim oARReporte As New rptAbonosContratosAll(Me.dsTraspasos, Me.ccmbDesde.Value, Me.ccbHasta.Value, Me.cmbCajas.Value)
    ...
    Private Sub frmReporteAbonos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End With
        Me.cmbCajas.Value = oAppContext.ApplicationConfiguration.NoCaja
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        If Not Me.cmbCajas.Text = String.Empty Then
            ...
            Me.dsTraspasos = oAbonosApartadosMgr.SelectByDateRerpote(Me.ccmbDesde.Value, Me.ccbHasta.Value, Me.cmbCajas.Value)
    ...
    Private Sub ExportarAbonos()
        ...
        wsxl = xlapp.Sheets(1)
        wsxl.Name = "REPORTE DE ABONOS"

        '****************************************
        'HOJA DE CALCULO APARTADOS EN TOTALES
        '****************************************
        wsxl.Cells(1, 1).Value = "REPORTE DE ABONOS DE LA CAJA No." & Me.cmbCajas.Value
