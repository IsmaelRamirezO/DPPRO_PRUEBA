...
Public Class frmInvTraspasoErroresCDISTCaptura
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmInvTraspasoErroresCDISTCaptura))
        ...
        '
        'frmInvTraspasoErroresCDISTCaptura
        '
        ...
        Me.Name = "frmInvTraspasoErroresCDISTCaptura"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Captura de Traspasos Para Ecommerce"
...
#End Region
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        If Not dtCorridaArticulo Is Nothing Then
            If MessageBox.Show("¿Deseas agregar el detalle?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = DialogResult.Yes Then
                uitnAgregar_Click(Nothing, Nothing)
            End If
        End If
