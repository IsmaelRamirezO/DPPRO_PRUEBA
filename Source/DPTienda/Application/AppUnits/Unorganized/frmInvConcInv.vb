...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmInvConcInv))
        ...
        Me.nebFolioConcen.Location = New System.Drawing.Point(465, 123)
        ...
        Me.Label18.Location = New System.Drawing.Point(376, 121)
        ...
        Me.ebMonedaDesc.Location = New System.Drawing.Point(497, 8)
        ...
        Me.ebMonedaCod.Location = New System.Drawing.Point(449, 8)
        ...
        Me.Label6.Location = New System.Drawing.Point(391, 8)
        ...
        Me.Name = "frmInvConcInv"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Traspaso de Salida por Concentración de Inventario"
...
#Region "Métodos Privados"
    ...
    Private Sub Sm_MostrarTraspasoInformacion()
        ...
        With oTraspasoSalida
            ...
            ebObservaciones.Text = "Concentra. de Inventario"
            'End If
    ...
    Private Sub Sm_GuardarTraspaso(Optional ByVal bolImprimir As Boolean = False)
        ...
        If (oTraspasoSalida Is Nothing) Then   'Opción Guardar.
            ...
            oTraspasoSalida.Referencia = EdBxFolioSAP.Text
            oTraspasoSalida.Modulo = "CI" 'Concentracion de Inventario
    ...
    Private Sub Sm_CapturaDetalle()
        ...
        Dim ofrmCapturaTraspasos As New frmInvConcInvCaptura(ebSucDestinoCod.Text)
...
#Region "Métodos Privados [Eventos]"
    ...
    Private Sub frmInvTraspasosDSalida_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim CatArt As New CatalogoArticuloManager(oAppContext)
        Dim dtMotivoDefectuoso As DataTable = CatArt.GetMotivosDefectuosos()
        ebObservaciones.DataSource = dtMotivoDefectuoso
        ...
        'ebObservaciones.Items.Add("Concentracion de Inventario", "1")
        'ebObservaciones.SelectedIndex = 0
    ...
    Public Sub PrintComprobanteTraspaso()
        ...
        If Not oTraspasoSalida Is Nothing Then
            ...
            Dim oARReporte As New rptReporteTraspasoDeSalida(oTraspasoSalida, "Concentración de Inventarios")
