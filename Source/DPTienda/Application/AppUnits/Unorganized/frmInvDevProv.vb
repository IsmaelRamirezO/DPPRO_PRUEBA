...
Public Class frmInvDevProv
    ...
    Private m_dtMotivoDefectuoso As DataTable
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmInvDevProv))
        ...
        Me.ebSucDestinoDesc.Location = New System.Drawing.Point(103, 43)
        ...
        Me.ebSucDestinoCod.Visible = False
        ...
        Me.ebMonedaDesc.Location = New System.Drawing.Point(496, 8)
        ...
        Me.ebMonedaCod.Location = New System.Drawing.Point(448, 8)
        ...
        Me.ebNumBulto.Location = New System.Drawing.Point(125, 66)
        ...
        Me.ebFechaRecepcion.Location = New System.Drawing.Point(125, 120)
        ...
        Me.ebNumGuia.Location = New System.Drawing.Point(125, 93)
        ...
        Me.ebReferencia.Location = New System.Drawing.Point(125, 39)
        ...
        Me.Name = "frmInvDevProv"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Traspaso de Salida por Devolución a Proveedor"
...
#Region "Variables Miembros"
    ...
    '------------------------------------------------------------------------------
    Private Const ALMACEN_DESTINO = "M008"
...
#Region "Métodos Privados"
    ...
    Private Sub Sm_TxtLimpiar()
        ...
        oSAP.ConfigCierreFI = oConfigCierreFI
    ...
    Private Sub Sm_MostrarTraspasoInformacion()
        ...
        With oTraspasoSalida
            ...
            'ebObservaciones.Text = "Devol. Proveedor"
            ebObservaciones.SelectedIndex = 0
            'End If
    ...
    Private Sub Sm_GuardarTraspaso(Optional ByVal bolImprimir As Boolean = False)
        ...
        If (oTraspasoSalida Is Nothing) Then   'Opción Guardar.
            ...
            End If
            hguia("doc_type") = "ZDTP"
            hguia("MotivoDevolucion") = ebObservaciones.SelectedValue
            Dim dtPedido As DataTable = odtArticulosTras.Copy()
            dtPedido.Columns.Add("MotivoDefectuoso", GetType(String))
            dtPedido.Columns.Add("ClaveConfirm", GetType(String))
            For Each row As DataRow In dtPedido.Rows
                row("MotivoDefectuoso") = "Z1"
                row("ClaveConfirm") = "0004"
                row.AcceptChanges()
            Next
            dtPedido.AcceptChanges()
            EdBxFolioSAP.Text = oSap.pedido_trasladomm02(dtPedido, "1000", "M008", hguia)
            ...
            oTraspasoSalida.Modulo = "DP" 'Devolucion a Proveedor
    ...
    Private Sub Sm_CapturaDetalle()
        ...
        Dim ofrmCapturaTraspasos As New frmInvDevProvCaptura(ebSucDestinoCod.Text)
...
#Region "Métodos Privados [Eventos]"
    ...
    Private Sub frmInvTraspasosDSalida_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '*** 
        Me.ebSucDestinoCod.Text = "A003"
        Me.ebSucDestinoDesc.Text = "Dev. Proveedores - C. DIST."

        Dim CatDef As New CatalogoArticuloManager(oAppContext)
        Me.m_dtMotivoDefectuoso = CatDef.GetMotivosDefectuosos()
        Dim view As New DataView(Me.m_dtMotivoDefectuoso, "CodMotivoDefectuoso IN ('01','03')", "", DataViewRowState.CurrentRows)
        ebObservaciones.DataSource = view
        ebObservaciones.DisplayMember = "MotivoDefectuoso"
        ebObservaciones.ValueMember = "CodMotivoDefectuoso"
        ebObservaciones.Refresh()
        'ebObservaciones.SelectedValue = ""
        'ebObservaciones.Text = String.Empty
        'ebObservaciones.Items.Clear()
        'ebObservaciones.Items.Add("Devol. Proveedor", "1")
        'ebObservaciones.SelectedIndex = 0
    ...
    Public Sub PrintComprobanteTraspaso()
        ...
        If Not oTraspasoSalida Is Nothing Then
            ...
            Dim oARReporte As New rptReporteTraspasoDeSalida(oTraspasoSalida, "Devolución a Proveedor")
