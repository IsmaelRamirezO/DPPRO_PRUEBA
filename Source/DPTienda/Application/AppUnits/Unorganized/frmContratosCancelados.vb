...
Public Class frmContratosCancelados
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmContratosCancelados))
        ...
        Me.ExplorerBar1.Size = New System.Drawing.Size(648, 576)
        ...
        Me.nbTotalapartados.Location = New System.Drawing.Point(416, 248)
        Me.nbTotalapartados.Name = "nbTotalapartados"
        Me.nbTotalapartados.ReadOnly = True
        Me.nbTotalapartados.Size = New System.Drawing.Size(104, 23)
        ...
        Me.Label5.Location = New System.Drawing.Point(296, 256)
        Me.Label5.Name = "Label5"
        Me.Label5.Size = New System.Drawing.Size(144, 23)
        Me.Label5.TabIndex = 132
        Me.Label5.Text = "Total Apartados:"
        '
        'Label3
        '
        ...
        Me.Label4.Location = New System.Drawing.Point(344, 280)
        ...
        'btnGenerar
        '
        Me.btnGenerar.Location = New System.Drawing.Point(400, 48)
        Me.btnGenerar.Name = "btnGenerar"
        Me.btnGenerar.Size = New System.Drawing.Size(104, 23)
        ...
        Me.ccbHasta.Location = New System.Drawing.Point(256, 48)
        ...
        Me.Label22.Location = New System.Drawing.Point(104, 280)
        ...
        Me.Label21.Location = New System.Drawing.Point(88, 280)
        ...
        Me.Label16.Location = New System.Drawing.Point(248, 280)
        ...
        Me.Label13.Location = New System.Drawing.Point(224, 280)
        ...
        '
        'frmContratosCancelados
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(544, 310)
        Me.Controls.Add(Me.ExplorerBar1)
        Me.KeyPreview = True
        Me.Name = "frmContratosCancelados"
        Me.Text = "Contratos Cancelados"
...
#End Region
    ...
    Public Sub ActionPreview()
        Try
            ...
            If Not Me.dsTraspasos Is Nothing Then
                ...
                Dim oARReporte As New rptApartadosCancelados(Me.dsTraspasos, Me.ccmbDesde.Value, Me.ccbHasta.Value)
                Dim oReportViewer As New ReportViewerForm



                oARReporte.Document.Name = "Apartados Totales"
                oARReporte.Run()
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        If Not Me.cmbCajas.Text = String.Empty Then
            ...
            Me.dsTraspasos = oContratosMgr.ContratoCanceladosSel(Me.ccmbDesde.Value, Me.ccbHasta.Value, Me.cmbCajas.Value)
    ...
    Private Sub frmContratosCancelados_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Cursor = Cursors.WaitCursor
        Me.ccmbDesde.MaxDate = ccbHasta.Value
    ...
    Private Sub frmContratosCancelados_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub ExportaApartadosTotales()
        ...
        wsxl = xlapp.Sheets(1)
        wsxl.Name = "Apartados Cancelados"

        '****************************************
        'HOJA DE CALCULO APARTADOS CANCELADOS
        '****************************************
        wsxl.Cells(1, 1).Value = "REPORTE DE APARTADOS CANCELADOS DE LA CAJA No." & Me.cmbCajas.Value
        ...
        wsxl.Range("A6:E6").Font.Bold = True
        wsxl.Range("A6:E6").HorizontalAlignment = 3
        wsxl.Range("A6:E6").Font.Size = 8
        wsxl.Range("A6:E6").Interior.Color = RGB(255, 255, 192)
        wsxl.Range("A6:E6").BorderAround(, 2, 0, )
        ...
        wsxl.Cells(8 + intRow, 2).Value = "TOTAL APARTADOS:"
