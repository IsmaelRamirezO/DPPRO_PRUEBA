...
Public Class frmInvTSxDefectuosos
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmInvTSxDefectuosos))
        ...
        Me.Label18.Location = New System.Drawing.Point(377, 121)
        Me.Label18.Name = "Label18"
        Me.Label18.Size = New System.Drawing.Size(114, 55)
        ...
        Me.ebSucDestinoDesc.Location = New System.Drawing.Point(102, 43)
        ...
        Me.EdBxFolioSAP.Size = New System.Drawing.Size(119, 23)
        ...
        Me.Label13.Location = New System.Drawing.Point(378, 99)
        ...
        Me.ebMonedaDesc.Location = New System.Drawing.Point(487, 8)
        ...
        Me.ebMonedaCod.Location = New System.Drawing.Point(439, 8)
        ...
        Me.ebFecha.Size = New System.Drawing.Size(119, 23)
        ...
        Me.ebResponsable.Location = New System.Drawing.Point(101, 123)
        ...
        Me.ebFolio.Size = New System.Drawing.Size(119, 23)
        ...
        Me.Label4.Location = New System.Drawing.Point(378, 48)
        ...
        Me.ebTransportistaDesc.Location = New System.Drawing.Point(169, 96)
        ...
        Me.ebSucOrigenDesc.Location = New System.Drawing.Point(169, 69)
        ...
        Me.ebTransportistaCod.Location = New System.Drawing.Point(102, 96)
        ...
        Me.ebSucOrigenCod.Location = New System.Drawing.Point(102, 69)
        ...
        Me.ebSucDestinoCod2.Location = New System.Drawing.Point(280, 16)
        ...
        Me.GridTraspasoCorrida.Size = New System.Drawing.Size(829, 224)
        ...
        Me.ebNumBulto.Location = New System.Drawing.Point(124, 43)
        ...
        Me.ebFechaRecepcion.Location = New System.Drawing.Point(124, 120)
        ...
        Me.ebFechaRecepcion.Visible = False
        ...
        Me.ebNumGuia.Location = New System.Drawing.Point(124, 70)
        ...
        Me.ebReferencia.Location = New System.Drawing.Point(124, 95)
        ...
        Me.Name = "frmInvTSxDefectuosos"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Traspaso de Salida por Defectuosos"
...
#Region "Variables Miembros"
    ...
    '------------------------------------------------------------------------------
    Private Const ALMACEN_DESTINO = "M007"
...
#Region "Métodos Privados"
    ...
    Private Sub Sm_TxtLimpiar()
        ...
        AlmacenOrigen = oCatalogoAlmacenMgr.Load(oSap.Read_Centros())
    ...
    Private Sub Sm_MostrarTraspasoInformacion()
        ...
        With oTraspasoSalida
            ...
            ebObservaciones.Text = "Por Defectuosos"
            'End If
    ...
    'AsignaTablas
    Private Function AsignaTablaG() As DataTable
        Dim dt As New DataTable("DefectuososG")
        'Codigo del articulo
        ...
        'Inicio corrida
        Dim dcNumIni As New DataColumn
        With dcNumIni
            ...
            .DefaultValue = ""
        End With
        dt.Columns.Add(dcNumIni)

        'Fin Corrida
        Dim dcNumFin As New DataColumn
        With dcNumFin
            .ColumnName = "NumFin"
            .DataType = GetType(String)
            .Caption = "Corrida FInal"
            .DefaultValue = ""
        End With
        dt.Columns.Add(dcNumFin)
    ...
    Private Function AsignaTablaD() As DataTable
        Dim dt As New DataTable("DefectuososD")
        'Codigo del articulo
        Dim dcCodArticulo As New DataColumn
        With dcCodArticulo
            .ColumnName = "CodArticulo"
        ...
        'Cantidad a desmarcar
        Dim dcDesmarcar As New DataColumn
        With dcDesmarcar
            ...
            .DefaultValue = 0
        End With
        dt.Columns.Add(dcDesmarcar)

        'Precio Unitario
        Dim dcPrecioUnit As New DataColumn
        With dcPrecioUnit
    ...
    Private Function AsignaTablaDet() As DataRow
        Dim dt As New DataTable("DefectuososD")
        'Codigo del articulo
        Dim dcCodArticulo As New DataColumn
        With dcCodArticulo
    ...
    Private Sub Sm_GuardarTraspaso(Optional ByVal bolImprimir As Boolean = False)
        ...
        If (oTraspasoSalida Is Nothing) Then   'Opción Guardar.
            ...
            '-----------------------------------------------------------------------------------------------------------------------------
            'JNAVA 05/03/2014: Validacion de los pedidos que estan pendientes por Facturar y Surtir
            '-----------------------------------------------------------------------------------------------------------------------------
            ...
            '-----------------------------------------------------------------------------------------------------------------------------------
            'JNAVA 05/03/2014: Obtener materiales libres
            '-----------------------------------------------------------------------------------------------------------------------------------
            ...
            'Desmarcado de los articulos seleccionados en SAP y tablas Locales
            Dim dsDefectuosos As New DataSet
            Dim drDefectuosoG As DataRow
            Dim drDefectuososD As DataRow
            Dim odrFiltroCorrida() As DataRow
            Dim strArticulos As String = ""
            Dim bool As Boolean = False
            Dim cantidad As Integer = 0
            Dim FolioDesmarcado As Integer = 0

            'Asignamos estructuras de tablas al dataset
            dsDefectuosos.Tables.Add(AsignaTablaG)
            dsDefectuosos.Tables.Add(AsignaTablaD)
            dsDefectuosos.AcceptChanges()


            'Asignamos Datarow con cmapos vacios
            drDefectuososD = AsignaTablaDet()

            'Extaer Catálogo Corridas.
            odsCatalogoCorridas = oTraspasoSalidaMgr.ExtraerCatalogoCorridas()

            'Validar que existan en el catalogo articulos los codigos a Traspasar
            For Each oRow As DataRow In odsTraspasoCorrida.Tables(0).Rows
                drDefectuosoG = oTraspasoSalidaMgr.GetDataGeneral(oRow.Item("CodArticulo"))
                If drDefectuosoG Is Nothing Then
                    MessageBox.Show("El artículo " & oRow.Item("CodArticulo") & " no existe en catalogo artículos", "DPTienda", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Exit Sub
                End If
            ...
            For Each oRow As DataRow In odsTraspasoCorrida.Tables(0).Rows
                ...
                drDefectuosoG = oTraspasoSalidaMgr.GetDataGeneral(oRow.Item("CodArticulo"))
                drDefectuosoG(1) = oRow.Item("Cantidad")
                ...
                If Not drDefectuosoG Is Nothing Then
                    ...
                    oArticulo = Nothing
                    oArticulo = oCatalogoArticuloMgr.Load(CType(oRow.Item("CodArticulo"), String))

                    'Obtener la corrida de cada Artículo.
                    odrFiltroCorrida = odsCatalogoCorridas.Tables("CatalogoCorridas").Select("CodCorrida = '" & CType(oRow.Item("CodCorrida"), String) & "'")   '.GetType.ToString & "'")
                    ...
                    '    intCantidadPorTalla = CType(oRow("C" & Format(intNumTalla, "00")), Integer)

                    drDefectuososD = AsignaTablaDet()

                    'If (intCantidadPorTalla > 0) Then

                    drDefectuososD(0) = oRow.Item("CodArticulo")
                    drDefectuososD(1) = 0 'CType(odrFiltroCorrida(0).Item("C" & Format(intNumTalla, "00")), String)
                    drDefectuososD(2) = CInt(oRow("Cantidad"))
                    drDefectuososD(3) = CInt(oRow("Cantidad"))
                    drDefectuososD(4) = oRow.Item("costounit")
                    drDefectuososD(5) = oRow.Item("costototal")

                    dsDefectuosos.Tables("DefectuososD").ImportRow(drDefectuososD)
                    'End If


                    'Next
                    cantidad += CInt(oRow("Cantidad"))
                    'Dim oDefMgr As New DefectuososManager(oAppContext, oAppSAPConfig)
                    'oDefMgr.DesmarcarDefectuosos(dsDefectuosos, oRow.Item("Cantidad"), oAppContext.Security.CurrentUser.Name, False)
                    'oDefMgr.DesmarcarDefectuosos(dsDefectuosos, oRow.Item("Cantidad"), oAppContext.Security.CurrentUser.Name, False, "0004")
                    'dsDefectuosos.Tables("DefectuososD").Clear()
            ...
            '''''*/
            Dim oDefMgr As New DefectuososManager(oAppContext, oAppSAPConfig)
            FolioDesmarcado = oDefMgr.DesmarcarDefectuosos(dsDefectuosos, cantidad, oAppContext.Security.CurrentUser.Name, False, "0004", False)
            Dim exportParameter As New Hashtable
            Dim importParameter As New Hashtable
            Dim t_return As New DataTable

            importParameter("guia") = Me.ebNumGuia.Text.Trim()
            importParameter("bulto") = Me.ebNumBulto.Text.Trim()
            importParameter("transportista") = Me.ebTransportistaDesc.Text.Trim()
            importParameter("FolioDesbloqueo") = FolioDesmarcado
            importParameter("observaciones") = Me.ebObservaciones.Text & " " & ebFolioObs.Text
            importParameter("MotivoDevolucion") = Me.ebObservaciones.SelectedValue


            '************ Ramiro Alcaraz Flores **********************
            Dim oSap As New ProcesoSAPManager(oAppContext, oAppSAPConfig)
            Dim dtMat As DataTable = odtArticulosTras.Clone()

            dtMat.Columns.Add("MotivoDefectuoso", GetType(String))
            Dim dtFaltantes As DataTable = dtMat.Clone()
            Dim codarticulo As String = ""
            Dim CatArticuloMgr As New CatalogoArticuloManager(oAppContext)
            Dim dtDetail As DataTable = Nothing
            Dim filarow As DataRow = Nothing
            Dim cantidadDefec As Integer = 0
            For Each row As DataRow In odtArticulosTras.Rows
                ...
                If Not dtDetail Is Nothing AndAlso dtDetail.Rows.Count > 0 Then
                    ...
                    Next
                Else
                    filarow = dtFaltantes.NewRow
                    filarow("CodArticulo") = CStr(row("CodArticulo"))
                    dtFaltantes.Rows.Add(filarow)
                End If
            Next
            ...
            If Not dtMat Is Nothing AndAlso dtMat.Rows.Count > 0 Then
                ...
                t_return = oSap.ZMM_PROCESO_ENVIO_DEFECTUOSOS(importParameter, exportParameter, dtMat)
                If CStr(exportParameter("E_ERROR")) = "X" Then
                    MessageBox.Show(CStr(exportParameter("MensajeError")), "Dportenis PRO", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Exit Sub
                Else
                    oDefMgr.UpdateDesmarcado(FolioDesmarcado, CStr(exportParameter("E_DOCFI_DESBLOQUEO")))
                    EdBxFolioSAP.Text = CStr(exportParameter("E_NUMTRASLADO"))

                    ' MLVARGAS (16.08.2022): Desmarcar los artículos defectuosos en la BD Local
                    Dim ds As DataSet = New DataSet
                    Dim dtCopy As DataTable = dsDefectuosos.Tables(1).Copy()
                    ds.Tables.Add(dtCopy)
                    oDefMgr.ActualizarDesmarcado(ds)
                End If
            End If
            ...
            For Each oRowFaltante As DataRow In dtFaltantes.Rows
                codigos += oRowFaltante!CodArticulo & ", "
            Next

            If codigos.Trim.Length > 0 Then
                MessageBox.Show("Este(os) material(es): " & codigos & " no se encuentra información para concluir con el traslado", "Dportenis PRO", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
            ...
            'EdBxFolioSAP.Text = oSap.pedido_trasladomm02(odtArticulosTras, "Z000", "A002")
            ...
            '    strNumTras = oSap.trasladomm02(EdBxFolioSAP.Text, Me.ebObservaciones.Text & " " & ebFolioObs.Text, "997")
            ...
            If Not dtMat Is Nothing AndAlso dtMat.Rows.Count > 0 Then
                ...
                oTraspasoSalida.AlmacenDestinoID = "997"
                ...
                oTraspasoSalida.Modulo = "DF" 'Defectuosos



                Dim ds As DataSet = New DataSet
                Dim dtCopy As DataTable = odsTraspasoCorrida.Tables(0).Copy()
                ds.Tables.Add(dtCopy)

                oTraspasoSalida.Detalle = ds 'odsTraspasoCorrida
        ...
        Else   'Opción Actualizar.
            ...
            oTraspasoSalida.TransportistaID = oTransportista.ID
            oTraspasoSalida.Status = "GRA"
            'oTraspasoSalida.AlmacenDestinoID = oAlmacenDestino.ID
            oTraspasoSalida.AlmacenDestinoID = "997"
            oTraspasoSalida.AlmacenOrigenID = oAppContext.ApplicationConfiguration.Almacen
            oTraspasoSalida.Referencia = String.Empty
    ...
    Private Sub Sm_AplicarTraspaso()
        ...
        'oTraspasoSalida.AlmacenDestinoID = "099"
        oTraspasoSalida.AlmacenDestinoID = "997"
    ...
    Private Sub Sm_CapturaDetalle()
        ...
        Dim ofrmCapturaTraspasos As New frmInvTSxDefectuososCaptura(ebSucDestinoCod.Text)
            ...
            If Not (odsTraspasoCorrida Is Nothing) Then
                ...
                If (odsTraspasoCorrida.Tables(0).Rows.Count > 0) Then
                    ...
                    With oTraspasoSalidaMgr
                        ...
                        For Each dr In dsDefec.Tables(0).Rows
                            ...
                            If Not (IsDBNull(dr!TotalMes) = True) Then
                                ...
                                If (dr!TotalMes > 0) Then
                                    ...
                                    oTraspasoSalidaMgr.AgregarArticulo(oArticulo, dr!Numero, dr!TotalMes, (oArticulo.CostoProm * dr!TotalMes), 0)
                        ...
                        'Actualizar la tabla temporal de acuerdo a los datos del dataset
                        oTraspasoSalidaMgr.ActualizarLecturado2(odsTraspasoCorrida)

                        ofrmCapturaTraspasos.UiButton1.Enabled = False
                        'Utilizar la propiedad TraspasoSalida.Detalle[DataSet], para llenar la Tabla Temporal.
                        '.GenerarTraspasoDetalleTemporal(odsTraspasoCorrida)
        ...
        Dim oDataView As New DataView(odtArticulosTras, "Lecturado =0", "CodArticulo", DataViewRowState.CurrentRows)


        If oDataView.Count > 0 Then
            For Each oDataViewRow As DataRowView In oDataView
                odtArticulosTras.Rows.Remove(oDataViewRow.Row)
            Next
        End If

        odtArticulosTras.AcceptChanges()

        '3.- Actualizar Grid [Traspaso Corrida] 

        'Eliminamos los codigos que no se lecturaron
        oTraspasoSalidaMgr.EliminarArticuloNoLecturado()
        ...
        For Each dr As DataRow In odsTraspasoCorrida.Tables(0).Rows
            dr("CostoTotal") = CType(dr("CostoUnit"), Decimal) * CType(dr("Lecturado"), Int16)
            dr("Cantidad") = dr("Lecturado")
        Next
...
#Region "Métodos Privados [Eventos]"
    ...
    Private Sub frmInvTraspasosDSalida_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.ebSucDestinoCod.Text = "A002"
        Me.ebSucDestinoDesc.Text = "A. Defectuosos - C. DIST."
        ...
        ebObservaciones.SelectedValue = "03"
        ebObservaciones.ReadOnly = True
        'ebObservaciones.Text = String.Empty
        'ebObservaciones.Items.Clear()
        'ebObservaciones.Items.Add("Por Defectuosos", "1")
    ...
    Public Sub PrintComprobanteTraspaso()
        ...
        If Not oTraspasoSalida Is Nothing Then
            ...
            Dim oARReporte As New rptReporteTraspasoDeSalida(oTraspasoSalida, "Por Defectuosos")
    ...
    Private Sub ebSucDestinoCod_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles ebSucDestinoCod2.Validating
        ...
        Else
            ...
            If oAppContext.Security.CurrentUser.SessionRole = 6 Or oAppContext.Security.CurrentUser.SessionRole = 7 Then
                ...
                ebObservaciones.Items.Add("Por Defectuosos", "14")
            Else
                ebObservaciones.Items.Clear()
                'ebObservaciones.Items.Add("Concentración de Producto", "7")
                'ebObservaciones.Items.Add("Dev. Error Trasp.", "8")
...
#Region "Facturacion SiHay"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------
    'JNAVA 05/03/2014: Envia el detalle con las cantidades libres Negadas
    '---------------------------------------------------------------------------------------------------------------------------------
