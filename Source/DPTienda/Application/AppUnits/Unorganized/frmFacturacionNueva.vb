...
Public Class frmFacturacionNueva
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmFacturacionNueva))
        ...
        Me.menuArchivo1.Visible = Janus.Windows.UI.InheritableBoolean.[True]
        '
        'menuHerramientas1
        '
        ...
        Me.MnuCargarArticulosSiHay1.Visible = Janus.Windows.UI.InheritableBoolean.[False]
        '
        'Separator9
        '
        ...
        Me.explorerBar1.Size = New System.Drawing.Size(682, 617)
        ...
        Me.txtPopupAdicional.TabIndex = 6
        ...
        Me.txtPopupDescuento.TabIndex = 5
        ...
        Me.dgHeader.DesignTimeLayout = GridEXLayout1
        ...
        Me.dgHeader.Size = New System.Drawing.Size(648, 206)
        ...
        Me.ebClienteDescripcion.Location = New System.Drawing.Point(272, 94)
        ...
        Me.lblCronometro.Location = New System.Drawing.Point(548, 92)
        ...
        Me.EbFolioSAP.Location = New System.Drawing.Point(128, 38)
        ...
        Me.ebCodCaja.Location = New System.Drawing.Point(609, 38)
        ...
        Me.Label18.Location = New System.Drawing.Point(542, 38)
        ...
        Me.ebCodVendedor.Location = New System.Drawing.Point(128, 122)
        ...
        Me.ebClienteID.Location = New System.Drawing.Point(128, 94)
        ...
        Me.ebFolioApartado.Location = New System.Drawing.Point(128, 66)
        ...
        Me.ebFolioFactura.Location = New System.Drawing.Point(128, 38)
        ...
        Me.ebTipoVenta.Location = New System.Drawing.Point(349, 66)
        ...
        Me.ebFechaFactura.Location = New System.Drawing.Point(349, 38)
        ...
        Me.btnAltaCliente.Location = New System.Drawing.Point(544, 120)
        ...
        Me.ebStatus.Location = New System.Drawing.Point(609, 66)
        ...
        Me.ebPlayerDescripcion.Location = New System.Drawing.Point(272, 122)
        ...
        Me.Label9.Location = New System.Drawing.Point(542, 66)
...
EligeTipoDescuento:
    ...
    Private Sub Valida()
        ...
        Else
            ...
            '---------------------------------------------------------------------------------------------------------------------------------------------
            If ValidaDatosObligatoriosCliente(oCliente) = False Then
...
Sigue:
    ...
    Private Sub AgregaFormasPagoDescuento(ByVal dtFP As DataTable, ByVal CodPromo As String)
        ...
        Dim bFiltrada As Boolean = False
        '-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub AplicaDescuentosCS(ByVal bAceptaPromo As Boolean, ByRef dtDetalleTemp As DataTable)
        ...
        If dsDetalle.Tables(0).Rows.Count > 0 AndAlso dsDetalle.Tables(0).Rows(0)!Codigo <> "" AndAlso bAceptaPromo Then
            ...
            'oRetail.SapZcsAlgoritmoPromos(dtDetalleTemp, Me.ebTipoVenta.Value, Today, htTotales, oAppContext.ApplicationConfiguration.Almacen, dtMatDesc, dtPromosCS, dtCS)
...
Continua:
    ...
    Private Function ValidaPromoAplicadaCS(ByVal dtDetalle As DataTable) As Boolean
        ...
        If strPromoID.Trim <> "" Then
            ...
            Dim oRetail As New ProcesosRetail("/pos/cs", "POST")
            Dim Inicio As Long, fin As Long, TimeRequest As Decimal
            ...
            TimeRequest = (fin - Inicio) / TimeSpan.TicksPerMillisecond
            EscribeLogTiempo("SapZcsPromoVigentes es por BUS", CStr(TimeRequest))
            '--------------------------------------------------------------------------------------
        ...
        If (oOpenRecordDlg.DialogResult = DialogResult.OK) Then
            ...
            Else
                ...
                If oFactura.CodTipoVenta = "V" Then
                    ...
                    '                     con la promoción Compre ahora y pague despues ya no cuadraban las quincenas
                    '--------------------------------------------------------------------------------------------------------------------------------------
                    If dpValeId > 0 Then
                        intNUMVA = dpValeId
                        oDPVale.I_RUTA = "X"
                        ...
                        If oDPVale.InfoDPVALE.Rows.Count > 0 Then strQuin = oDPVale.InfoDPVALE.Rows(0)!NUMDE
...
10:             frmPagoCliente.dtFormasPago = Me.FormasPago.Copy
            End If
            '---------------------------------------------------------------------------------------------------------------------------------
            'FLIZARRAGA 08/05/2013: Se hace la validación para agregar las cantidades libres que ya fueron restadas de los pedidos pendientes'
            '---------------------------------------------------------------------------------------------------------------------------------
...
#End Region
    ...
    Private Sub txtPopupCodigo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtPopupCodigo.KeyDown
        Select Case e.KeyCode
            ...
            Case Keys.F2
                ...
                End If
                'Case Keys.Enter
                '    If Me.txtPopupCodigo.Text <> String.Empty Then
    ...
    Public Function CargarCodigo()
        ...
        If modificar = False Then
            If txtPopupCodigo.Text.Trim() <> "" Then
                ...
                If oCatalogoUPCMgr.IsSkuOrMaterial(txtPopupCodigo.Text.Trim()) = "S" Then
                    ...
                    If dsUPC.Rows.Count > 0 Then
                        ...
                        If dataRow Is Nothing Then
                            ...
                            Else
                                ...
                                End If
                                ActualizaCalculos()
                                CargarCodigoSH(txtPopupCodigo.Text.Trim())
                            End If
                        Else
                            ActualizaDatosArticuloJanus(txtPopupCodigo.Text.Trim) ', txtPopupTalla.Text.Trim())
    ...
    Private Function CalcularCantidad()
        ...
        Dim existe As Boolean = CorridaMgr.IsArticuloEnAlmacen(CodArticuloPopup)
        ...
        Else
            '--------------------------------------------------------------------------------------------------------------------------
            ' JNAVA (09.03.2017): Svalidamos la existencia del material
            '--------------------------------------------------------------------------------------------------------------------------
            oFacturaMgr.GetExistenciaArticulo(CodArticuloPopup, oAppContext.ApplicationConfiguration.Almacen, txtPopupTalla.Text.Trim(), oFactura)
            If oFactura.FacturaArticuloExistencia = 0 Then
                MessageBox.Show("No se cuenta con existencia en esta Talla. ", "Dportenis PRO", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Me.txtPopupTalla.Text = String.Empty
                Me.txtPopupTalla.Focus()
                Exit Function
            End If
            ...
            '--------------------------------------------------------------------------------------------------------------------------
            ' JNAVA (05.09.2017): Validamos que la existencia ingresada no se mayor que la del inventario
            '--------------------------------------------------------------------------------------------------------------------------
            If CDec(txtCantidad.Value) > oFactura.FacturaArticuloExistencia Then
                MessageBox.Show("Esta talla no cuenta con esa cantidad en existencia. ", "Dportenis PRO", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Me.txtCantidad.Focus()
                Exit Function
            End If
            '--------------------------------------------------------------------------------------------------------------------------
    ...
    Public Function ValidarArticuloManual() As Boolean
        ...
        If existe = False Then
            ...
            '-------------------------------------------------------------------------------------------------------------------------------
            If Not oConfigCierreFI.ArticuloCatalogoSH Then
                GoTo NoExiste
            End If
            ...
            If Me.txtPopupCodigo.Text.Trim <> "" Then
                oArticulo.ClearFields()
                oArticuloMgr.LoadInto(CodArticuloPopup, oArticulo)
...
NoExiste:
    ...
    Public Function SaveArticuloDataTable() As Boolean
        ...
        Try
            row = BuscaCodigoVentaJanus(CodArticuloPopup) ', txtPopupTalla.Text.Trim())
            If row Is Nothing Then
                row = dsDetalle.Tables(0).NewRow()
                row("CodProveedor") = txtPopupCodigo.Text.Trim()
                row("Codigo") = CodArticuloPopup
                art = ArticuloMgr.Create()
    ...
    Private Sub txtCantidad_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtCantidad.Validating
        If (Not txtCantidad.Value Is Nothing AndAlso CDec(txtCantidad.Value) <> 0) AndAlso Me.txtPopupCodigo.Text.Trim <> String.Empty Then
            CalcularCantidad()
        End If
    End Sub
...
#Region "Metodos Filtros Descuentos"
    ...
    Public Sub InsertarCodigo(ByVal codigo As String)
        ...
        ActualizaDatosArticuloJanus(codigo)
        ...
        If oConfigCierreFI.GenerarSeguro Then 'Revisamos config
            ...
            If oFactura.CodTipoVenta = "V" Then 'Revisamos Tipo de venta
                ...
                If DPValeID > 0 Then
                    ...
                    '---------------------------------------------------
                    Beneficiario = oS2Credit.ObtenerBeneficiarioSeguro(CStr(DPValeID).TrimEnd.PadLeft(10, "0"), FechaCobro)
...
#Region "Eventos"
    ...
    Private Sub btnPromosAplicadas_Click(sender As System.Object, e As System.EventArgs) Handles btnPromosAplicadas.Click
...
#Region "Facturacion Nueva"
    ...
    Private Sub txtPopupTalla_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles txtPopupTalla.Validating
        If txtPopupCodigo.Text.Trim() <> "" Then
            '-----------------------------------------------------------------------------
