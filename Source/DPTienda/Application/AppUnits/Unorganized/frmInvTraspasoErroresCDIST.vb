...
Public Class frmInvTraspasoErroresCDIST
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents ebFolioTO As Janus.Windows.GridEX.EditControls.EditBox
    Friend WithEvents Label18 As System.Windows.Forms.Label
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim ExplorerBarGroup1 As Janus.Windows.ExplorerBar.ExplorerBarGroup = New Janus.Windows.ExplorerBar.ExplorerBarGroup()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmInvTraspasoErroresCDIST))
        ...
        Me.ebFolioTO = New Janus.Windows.GridEX.EditControls.EditBox()
        ...
        Me.ExplorerBar1.Controls.Add(Me.ebFolioTO)
        ...
        'ebFolioTO
        '
        Me.ebFolioTO.AutoScrollMargin = New System.Drawing.Size(0, 0)
        Me.ebFolioTO.AutoScrollMinSize = New System.Drawing.Size(0, 0)
        Me.ebFolioTO.Location = New System.Drawing.Point(458, 123)
        Me.ebFolioTO.Name = "ebFolioTO"
        Me.ebFolioTO.Size = New System.Drawing.Size(112, 23)
        Me.ebFolioTO.TabIndex = 21
        Me.ebFolioTO.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
        Me.ebFolioTO.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2003
        '
        'Label18
        '
        ...
        Me.Label18.Location = New System.Drawing.Point(392, 123)
        Me.Label18.Name = "Label18"
        Me.Label18.Size = New System.Drawing.Size(58, 14)
        Me.Label18.TabIndex = 22
        Me.Label18.Text = "TOrigen:"
        '
        'ebSucDestinoDesc
        '
        ...
        Me.ebSucDestinoDesc.Location = New System.Drawing.Point(120, 43)
        Me.ebSucDestinoDesc.Name = "ebSucDestinoDesc"
        Me.ebSucDestinoDesc.ReadOnly = True
        Me.ebSucDestinoDesc.Size = New System.Drawing.Size(267, 23)
        ...
        Me.ebSucDestinoCod.Location = New System.Drawing.Point(120, 43)
        ...
        Me.EdBxFolioSAP.Location = New System.Drawing.Point(458, 96)
        ...
        Me.ebFecha.Location = New System.Drawing.Point(458, 69)
        ...
        Me.ebFolio.Location = New System.Drawing.Point(458, 43)
        ...
        Me.ebFechaRecepcion.Location = New System.Drawing.Point(104, 120)
        ...
        Me.ebObservaciones.Location = New System.Drawing.Point(304, 80)
        Me.ebObservaciones.Multiline = True
        Me.ebObservaciones.Name = "ebObservaciones"
        Me.ebObservaciones.Size = New System.Drawing.Size(528, 56)
        Me.ebObservaciones.TabIndex = 83
        ...
        Me.Name = "frmInvTraspasoErroresCDIST"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Traspaso de Salida para Errores del CDist"
...
#Region "Métodos Privados"
    ...
    Private Sub Sm_TxtLimpiar()
        ...
        AlmacenOrigen = oCatalogoAlmacenMgr.Load("2" & oAppContext.ApplicationConfiguration.Almacen)
    ...
    Private Function Fm_bolTxtValidar(ByRef oTraspasoEntradaTemp As TraspasoEntrada) As Boolean
        ...
        If (ebSucOrigenCod.Text = String.Empty) OrElse (ebResponsable.Text = String.Empty) Then
            MsgBox("Para Guardar un Traspaso vaya a la Opción Nuevo.", MsgBoxStyle.Exclamation, "DPTienda")
            Exit Function
        End If


        If (ebSucOrigenCod.Text = Me.ebSucDestinoCod.Text) Then
        ...
        If ebNumGuia.Text.Trim = "" Then 'OrElse CLng(Me.ebNumGuia.Text) < oConfigCierreFI.MinimoEC OrElse CLng(Me.ebNumGuia.Text) > oConfigCierreFI.MaximoEC Then
            MsgBox("El numero de guia no es valido.", MsgBoxStyle.Exclamation, "DPTienda")
            ebNumGuia.Focus()
            Exit Function
        End If

        If (Me.ebFolioTO.Text.Trim = String.Empty) Then
            MsgBox("Es necesario especificar el folio de traslado de origen.", MsgBoxStyle.Exclamation, "DPTienda")
            Me.ebFolioTO.Focus()
            Exit Function
        End If
        ...
        If (Me.ebFolioObs.Text.Trim = String.Empty AndAlso Me.ebFolioObs.Visible) Then
        ...
        Dim dtDetalleSalida As DataTable = oTraspasoSalidaMgr.FillTablaParaSAP

        oTraspasoEntradaTemp = oTraspasoEntradaMgr.LoadByFolioSAP(Me.ebFolioTO.Text.Trim)

        If oTraspasoEntradaTemp Is Nothing Then
            MessageBox.Show("El traslado origen no existe o no está aplicado.", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Me.ebFolioTO.Focus()
            Exit Function
        ElseIf InStr("Z001,Z000", oSapMgr.Read_Centros(oTraspasoEntradaTemp.AlmacenOrigenID.Trim).Trim) <= 0 Then
            MessageBox.Show("El traslado origen no pertenece al Centro de Distribución.", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Me.ebFolioTO.Focus()
            Exit Function
        ElseIf ValidarDetalleTraspaso(dtDetalleSalida, oTraspasoEntradaTemp.Detalle.Tables(0)) = False Then
            Exit Function
        End If
    ...
    Private Sub Sm_MostrarTraspasoInformacion()
        ...
        With oTraspasoSalida
            ...
            Me.ebFolioTO.Text = .TEOrigen.Trim
            ...
            '    End If
            'Else
            ebObservaciones.Text = .Observaciones.Trim
            'ebObservaciones.Text = "Traspaso para Ecommerce"
            'End If
    ...
    Private Sub Sm_GuardarTraspaso(Optional ByVal bolImprimir As Boolean = False)
        ...
        If (oTraspasoSalida Is Nothing) Then   'Opción Guardar.
            ...
            If (Fm_bolTxtValidar(oTraspasoEntradaTemp) = False) Then
                Exit Sub
            End If
            ...
            strCentro = oSap.Read_Centros(oTraspasoEntradaTemp.AlmacenOrigenID)

            Me.ebSucDestinoCod.Text = strCentro.Trim
            ...
            EdBxFolioSAP.Text = oSap.pedido_trasladomm02(odtArticulosTras, strCentro.Trim.ToUpper, "M001", hGuia)
            ...
            Else
                ...
                'strNumTras = oSap.trasladomm02(EdBxFolioSAP.Text, Me.ebObservaciones.Text & " " & ebFolioObs.Text, oTraspasoEntradaTemp.AlmacenOrigenID) '"999")
            ...
            '-----------------------------------------------------------------------------------------------------------------------------------
            'oSap.SaveInfoPaqueteria(EdBxFolioSAP.Text, Me.ebNumGuia.Text, "F01")
            ...
            oTraspasoSalida.AlmacenDestinoID = oTraspasoEntradaTemp.AlmacenOrigenID.Trim '"996"
            ...
            oTraspasoSalida.TEOrigen = Me.ebFolioTO.Text.Trim
            oTraspasoSalida.Modulo = "EA" 'Errores Almacen
            ...
            '----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Try
                oTraspasoSalidaMgr.SaveInServer(oTraspasoSalida, odtArticulosTras)
            Catch ex As Exception
                EscribeLog(ex.ToString, "Error al guardar el traspaso de salida por errores en el cdist " & oTraspasoSalida.TraspasoID & " en el server.")
            End Try
            ...
            Sm_AplicarTraspaso()
            '------------------------------------------------------------------------------------------------------------------------------------------------------------------
            'Enviamos correo con la info del traspaso a los correos configurados por errores del cdist
            '------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Try
                EnviarCorreoPorErrores(odtArticulosTras, EdBxFolioSAP.Text.Trim)
            Catch ex As Exception
                EscribeLog(ex.ToString, "Error al enviar correo del traspaso " & EdBxFolioSAP.Text)
            End Try
            '------------------------------------------------------------------------------------------------------------------------------------------------------------------
            'Actualizamos los codigos en las tablas de ControArticulosNoLecturados
            '------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Try
                oTraspasoEntradaMgr.UpdateArtNoLecturados(Me.ebFolioTO.Text.Trim, odtArticulosTras)
            Catch ex As Exception
                EscribeLog(ex.ToString, "Error al actualizar los articulos no lecturados en el traspaso de salida " & EdBxFolioSAP.Text)
            End Try
            '------------------------------------------------------------------------------------------------------------------------------------------------------------------
            'Actualizamos los codigos en las tablas de ControArticulosNoLecturados en el server
            '------------------------------------------------------------------------------------------------------------------------------------------------------------------
            Try
                oTraspasoEntradaMgr.UpdateArtNoLecturadosServer(Me.ebFolioTO.Text.Trim, odtArticulosTras)
            Catch ex As Exception
                EscribeLog(ex.ToString, "Error al actualizar los articulos no lecturados en el server en el traspaso de salida " & EdBxFolioSAP.Text)
            End Try
        ...
        Else   'Opción Actualizar.
            ...
            oTraspasoSalida.TransportistaID = oTransportista.ID
            oTraspasoSalida.Status = "GRA"
            oTraspasoSalida.AlmacenDestinoID = "996"
            oTraspasoSalida.AlmacenOrigenID = oAppContext.ApplicationConfiguration.Almacen
            oTraspasoSalida.Referencia = String.Empty
    ...
    Private Sub EnviarCorreoPorErrores(ByVal dtTemp As DataTable, ByVal strFolioTS As String)
        ...
        If dtTemp.Rows.Count > 0 Then
            ...
            'If strFolioTS.Trim <> "" Then
            '    strruta = "C:\" & strFolioTS.Trim & ".txt"
            ...
            'Pongo el encabezado
            txtWriter.WriteLine("FOLIO TRASLADO:" & strFolioTS.Trim & "     FECHA:" & Date.Today.ToShortDateString)
            ...
            txtWriter.WriteLine(Chr(13))
            txtWriter.WriteLine(Chr(13))
            txtWriter.WriteLine("ARTICULO            TALLA     CANTIDAD  DESCRIPCION")
            txtWriter.WriteLine("")

            'Pongo los articulos en el archivo txt
            Dim oRowCorreo As DataRow
            For Each oRowCorreo In dtTemp.Rows 'dvCorreo
                txtWriter.WriteLine(CStr(oRowCorreo.Item("CodArticulo")).PadRight(20, "") & CStr(oRowCorreo.Item("Talla")).PadRight(10, "") & CStr(oRowCorreo.Item("Cantidad")).PadRight(10, "") & oRowCorreo.Item("Descripcion"))
            Next
            ...
            For Each strTemp As String In oConfigCierreFI.CuentasCorreoErroresCDist
                If strTemp.Trim <> "" Then
                    strTo &= strTemp & ";"
                End If
            Next
            'For i As Integer = 0 To oConfigCierreFI.CuentasCorreoErroresCDist.Length - 2
            '    strTo &= oConfigCierreFI.CuentasCorreoErroresCDist(i)
            '    If i < oConfigCierreFI.CuentasCorreoErroresCDist.Length - 2 Then
            '        strTo &= ";"
            '    End If
            'Next
            ...
            mmMail.Subject = "Traspaso por Error en Traspaso de Entrada: " & ebFolioTO.Text.Trim
            mmMail.Body = "En al archivo adjunto vienen los articulos que devolvieron por error en Traspaso de Entrada:" & ebFolioTO.Text.Trim
            ...
            Catch ex As Exception
                MessageBox.Show("No se pudo enviar correo de Sobrantes en Traspaso de Entrada." & Microsoft.VisualBasic.vbCrLf & "Favor de enviarlo manualmente a Gabriel Quintero." & Microsoft.VisualBasic.vbCrLf & Microsoft.VisualBasic.vbCrLf & "La ruta es C:\" & Microsoft.VisualBasic.vbCrLf & "Archivo:" & strArchivo, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Information)
            End Try

        End If
    End Sub

    Private Function ValidarDetalleTraspaso(ByVal dtDetalleTS As DataTable, ByVal dtDetalleTE As DataTable) As Boolean

        Dim oRowE As DataRow
        Dim oRowS As DataRow
        Dim bRes As Boolean = True
        Dim bEnc As Boolean
        Dim bCantMayor As Boolean

        For Each oRowS In dtDetalleTS.Rows
            For Each oRowE In dtDetalleTE.Rows
                bEnc = False
                bCantMayor = False
                If CStr(oRowE!Codigo).Trim.ToUpper = CStr(oRowS!CodArticulo).Trim.ToUpper AndAlso CStr(oRowS!Talla).Trim.ToUpper = CStr(oRowE!Talla).Trim.ToUpper Then
                    bEnc = True
                    If CInt(oRowS!Cantidad) > CInt(oRowE!Cantidad) Then bCantMayor = True
                    Exit For
                End If
            Next
            If bEnc = False OrElse bCantMayor Then Exit For
        Next

        If bEnc = False Then
            MessageBox.Show("Hay codigos en el traspaso de salida que no se encuentran en el traspaso origen.", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            bRes = False
        End If
        If bCantMayor = True Then
            MessageBox.Show("Hay cantidades mayores a la del traspaso origen en algunos codigos.", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            bRes = False
        End If
    ...
    Private Sub Sm_CapturaDetalle()
        ...
        Dim ofrmCapturaTraspasos As New frmInvTraspasoErroresCDISTCaptura(ebSucDestinoCod.Text)
...
#Region "Métodos Privados [Eventos]"
    ...
    Private Sub frmInvTraspasosDSalida_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oTraspasoSalidaMgr = New TraspasosSalidaManager(oAppContext, oConfigCierreFI)
        ...
        'ebObservaciones.Items.Add("Traspaso para Ecommerce", "1")
    ...
    Public Sub PrintComprobanteTraspaso()
        ...
        If Not oTraspasoSalida Is Nothing Then
            ...
            Dim oARReporte As New rptReporteTraspasoDeSalida(oTraspasoSalida, "Errores del CDIST")
    ...
    Private Sub ebNumGuia_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
...
#End Region
    ...
    Private Sub ebNumGuia_Validating1(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles ebNumGuia.Validating

        'If Me.ebNumGuia.Text.Trim <> "" AndAlso IsNumeric(Me.ebNumGuia.Text) = False Then
        '    Me.ebNumGuia.Text = ""
        '    Me.ebNumGuia.Focus()
        'End If
