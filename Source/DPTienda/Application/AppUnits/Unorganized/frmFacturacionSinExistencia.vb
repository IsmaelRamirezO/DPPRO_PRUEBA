...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.UiCommandBar1.Size = New System.Drawing.Size(668, 22)
        ...
        Me.TopRebar1.Size = New System.Drawing.Size(668, 50)
        '
        'explorerBar1
        '
        ...
        Me.explorerBar1.Size = New System.Drawing.Size(668, 617)
        ...
        Me.ClientSize = New System.Drawing.Size(668, 667)
...
Existe:
    ...
    Public Function ValidarArticuloManual() As Boolean
        ...
        '--------------------------------------------------------------------------------------------------------------------------
        'MLVARGAS 09/02/2022: Descargar los datos del artículo solicitado de SAP, se comenta a petición de Francisco
        '--------------------------------------------------------------------------------------------------------------------------

        'ActualizaProducto(Me.CodArticulo)

        '--------------------------------------------------------------------------------------------------------------------------
        'MLVARGAS 16/05/2022: Volver a cargar el artículo, una vez actualizado, ya no aplica al comentar el punto anterior
        '--------------------------------------------------------------------------------------------------------------------------
...
#Region "Correcciones Ventas Incompletas"
    ...
    Private Sub AjustaTotales()
        ...
        For Each oRow As DataRow In dtArticulos.Rows
            ...
            Dim cantidad As Integer = oRow!Cantidad
            Dim libres As Integer = oRow!ConExistencia 'oRow!Stock 
            Dim faltantes As Integer = oRow!SinExistencia
