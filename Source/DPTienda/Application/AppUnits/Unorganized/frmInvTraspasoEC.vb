...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmInvTraspasoEC))
        ...
        Me.EdBxFolioSAP.Location = New System.Drawing.Point(465, 96)
        ...
        Me.ebFecha.Location = New System.Drawing.Point(465, 69)
        ...
        Me.ebFolio.Location = New System.Drawing.Point(465, 43)
        ...
        Me.ebNumGuia.Location = New System.Drawing.Point(124, 93)
        ...
        Me.ebNumBulto.Location = New System.Drawing.Point(124, 66)
        ...
        Me.ebReferencia.Location = New System.Drawing.Point(124, 39)
        ...
        Me.Name = "frmInvTraspasoEC"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Traspaso de Salida para Ecommerce"
...
#Region "Métodos Privados"
    ...
    Private Function Fm_bolTxtValidar() As Boolean
        ...
        If ebNumGuia.Text.Trim = "" OrElse CLng(Me.ebNumGuia.Text) < oConfigCierreFI.MinimoEC OrElse CLng(Me.ebNumGuia.Text) > oConfigCierreFI.MaximoEC Then
            MsgBox("El número de pedido no es valido.", MsgBoxStyle.Exclamation, "DPTienda")
            ebNumGuia.Focus()
            Exit Function
        End If
    ...
    Private Sub Sm_GuardarTraspaso(Optional ByVal bolImprimir As Boolean = False)
        ...
        If (oTraspasoSalida Is Nothing) Then   'Opción Guardar.
            ...
            '    dtNegados = NegarMaterialesPedidosTS(odtArticulosTras, dtDefectuososEC, dtDefecECSAP)
            ...
            Next
            dtMat.AcceptChanges()
            EdBxFolioSAP.Text = oSap.pedido_trasladomm02(dtMat, "1000", "M009", hGuia) 'oSap.Read_Centros("996"), "M001") '"Z001", "A001")
            ...
            Else
                ...
                'strNumTras = oSap.trasladomm02(EdBxFolioSAP.Text, Me.ebObservaciones.Text & " " & ebFolioObs.Text, "996")
            ...
            oTraspasoSalida.Referencia = EdBxFolioSAP.Text.Trim()
            oTraspasoSalida.Modulo = "EC" 'Ecommerce
    ...
    Private Sub Sm_CapturaDetalle()
        ...
        Dim ofrmCapturaTraspasos As New frmInvTraspasoEcCaptura(ebSucDestinoCod.Text)
...
#Region "Métodos Privados [Eventos]"
    ...
    Public Sub PrintComprobanteTraspaso()
        ...
        If Not oTraspasoSalida Is Nothing Then
            ...
            Dim oARReporte As New rptReporteTraspasoDeSalida(oTraspasoSalida, "Ecommerce")
