...
Public Class frmPagoEcommMenu
    ...
    Public Function GetIPCajaNo1() As String
        Dim ip As String = ""
        Dim oCaja As Caja
        oCaja = oCajaMgr.Create

        oCaja = oCajaMgr.Load("01")
    ...
    Public Sub New(ByVal oResponse As Dictionary(Of String, Object), ByVal configEcomm As ConfigEcomm, ByVal Vendedor As String, ByVal nombrePlayer As String, ByVal numPedido As String)
        ...
        If oAppContext.ApplicationConfiguration.NoCaja = "01" Then
            ipLocal = GetLocalIpAddress()
        Else
            ipLocal = GetIPCajaNo1()
        End If

        urlServicio = "http://" & ipLocal.Trim & ":" & port.Trim & "/?sucursal=" & oAppContext.ApplicationConfiguration.Almacen
        Me.Text = urlServicio
        player = Vendedor
        ...
        webApiEcomm.WebView.Url = urlServicio
        Console.WriteLine("URL: " & webApiEcomm.WebView.Url)
...
#End Region
    ...
    Private Sub frmPagoEcommMenu_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmPagoEcommMenu_FormClosed(sender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
