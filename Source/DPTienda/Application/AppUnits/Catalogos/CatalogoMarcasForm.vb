...
Public Class CatalogoMarcasForm
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(CatalogoMarcasForm))
        ...
        Me.UiCommandManager1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.menuArchivo, Me.menuAyuda, Me.menuSalir, Me.menuArchivoNuevo, Me.menuAyudaTema, Me.menuArchivoAbrir})
        ...
        Me.UiCommandBar2.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.Separator1, Me.menuArchivoAbrir2, Me.Separator2, Me.menuAyudaTema2})
        ...
        'menuArchivoAbrir
        '
        Me.menuArchivoAbrir.CommandStyle = Janus.Windows.UI.CommandBars.CommandStyle.TextImage
        ...
        ExplorerBarGroup1.Text = "Datos Generales Marcas"
        Me.ExplorerBar1.Groups.AddRange(New Janus.Windows.ExplorerBar.ExplorerBarGroup() {ExplorerBarGroup1})
        Me.ExplorerBar1.Location = New System.Drawing.Point(0, 48)
        Me.ExplorerBar1.Name = "ExplorerBar1"
        Me.ExplorerBar1.Size = New System.Drawing.Size(392, 128)
    ...
    Private Sub Sm_Buscar(Optional ByVal Vpa_bolOpenRecordDialog As Boolean = False)
        ...
        If ((Vpa_bolOpenRecordDialog = True) Or (EditBox1.Text.Trim = String.Empty)) Then
            ...
            If (oOpenRecordDlg.DialogResult = DialogResult.OK) Then
                ...
                oMarca = Nothing
                oMarca = oCatalogoMarcasMgr.Load(oOpenRecordDlg.Record.Item("CodMarca"))

                EditBox1.Text = oMarca.CodMarca
                EditBox2.Text = oMarca.Descripcion
                EditBox1.Focus()
                EditBox1.SelectAll()
        ...
        Else
            ...
            oMarca = Nothing
            oMarca = oCatalogoMarcasMgr.Load(EditBox1.Text.Trim)

            If oMarca.IsDirty Then
...
#Region "Metodos Privados"
    ...
    Private Sub CatalogoMarcasForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        oCatalogoMarcasMgr = New CatalogoMarcasManager(oAppContext)
    End Sub

    Private Sub CatalogoMarcasForm_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        oMarca = Nothing

        oCatalogoMarcasMgr.Dispose()
...
#End Region
    ...
    Private Sub CatalogoMarcasForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
