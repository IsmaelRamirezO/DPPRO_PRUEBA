...
Public Class CatalogoPlazasForm
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(CatalogoPlazasForm))
        ...
        Me.UiCommandBar2.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.menuArchivoAbrir2, Me.Separator1, Me.menuAyudaTema2})
        ...
        'menuArchivoAbrir2
        '
        Me.menuArchivoAbrir2.Image = CType(resources.GetObject("menuArchivoAbrir2.Image"), System.Drawing.Image)
        Me.menuArchivoAbrir2.Key = "menuArchivoAbrir"
        Me.menuArchivoAbrir2.Name = "menuArchivoAbrir2"
        Me.menuArchivoAbrir2.Text = "A&brir"
        '
        'Separator1
        '
        ...
        Me.menuArchivoAbrir1.Text = "A&brir"
        '
        'menuAyuda
        '
        ...
        ExplorerBarGroup1.Text = "Datos Generales Plazas"
        Me.ExplorerBar1.Groups.AddRange(New Janus.Windows.ExplorerBar.ExplorerBarGroup() {ExplorerBarGroup1})
        Me.ExplorerBar1.Location = New System.Drawing.Point(0, 56)
        Me.ExplorerBar1.Name = "ExplorerBar1"
        Me.ExplorerBar1.Size = New System.Drawing.Size(400, 129)
        ...
        Me.Name = "CatalogoPlazasForm"
        Me.Text = "Catalogo Plazas"
    ...
    Private Sub Sm_Buscar(Optional ByVal Vpa_bolOpenRecordDialog As Boolean = False)
        ...
        If ((Vpa_bolOpenRecordDialog = True) Or (EditBox1.Text.Trim = String.Empty)) Then
            ...
            If (oOpenRecordDlg.DialogResult = DialogResult.OK) Then
                ...
                EditBox1.Text = oPlaza.CodPlaza
                EditBox2.Text = oPlaza.Descripcion
                EditBox1.Focus()
                EditBox1.SelectAll()
        ...
        Else
            ...
            oPlaza = Nothing
            oPlaza = oCatalogoPlazasMgr.Load(EditBox1.Text.Trim)

            If oPlaza.IsDirty Then
                MessageBox.Show("No existe plaza", "DPTienda", MessageBoxButtons.OK, MessageBoxIcon.Information)
                EditBox1.Focus()
                EditBox1.SelectAll()
            Else
                EditBox1.Text = oPlaza.CodPlaza
...
#Region "Métodos Privados [Eventos]"
    ...
    Private Sub CatalogoPlazasForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CatalogoPlazasForm_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
...
#End Region
    ...
    Private Sub CatalogoPlazasForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
