...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.UiCommandManager1.Id = New System.Guid("bd5f169b-c341-4ac9-944a-4f5c70fa315d")
        ...
        ExplorerBarGroup1.Text = "Datos Generales Estado"
        Me.ExplorerBar1.Groups.AddRange(New Janus.Windows.ExplorerBar.ExplorerBarGroup() {ExplorerBarGroup1})
        Me.ExplorerBar1.Location = New System.Drawing.Point(0, 48)
        Me.ExplorerBar1.Name = "ExplorerBar1"
        Me.ExplorerBar1.Size = New System.Drawing.Size(392, 120)
        ...
        Me.NumericEditBox1.Location = New System.Drawing.Point(112, 48)
        Me.NumericEditBox1.MaxLength = 4
        Me.NumericEditBox1.Name = "NumericEditBox1"
        Me.NumericEditBox1.Size = New System.Drawing.Size(112, 22)
        Me.NumericEditBox1.TabIndex = 2
        ...
        Me.EditBox2.Location = New System.Drawing.Point(112, 72)
        Me.EditBox2.Name = "EditBox2"
        Me.EditBox2.ReadOnly = True
        Me.EditBox2.Size = New System.Drawing.Size(208, 22)
    ...
    Private Sub Sm_Buscar(Optional ByVal Vpa_bolOpenRecordDialog As Boolean = False)
        ...
        If ((Vpa_bolOpenRecordDialog = True) Or (NumericEditBox1.Text = 0)) Then
            ...
            If (oOpenRecordDlg.DialogResult = DialogResult.OK) Then
                ...
                NumericEditBox1.Text = oEstado.CodEstado
                EditBox2.Text = oEstado.Descripcion
        ...
        Else
            ...
            oEstado = Nothing
            oEstado = oCatalogoEstadosMgr.Load(NumericEditBox1.Text)
...
#Region "Métodos Privados [Eventos]"
    ...
    Private Sub frmEstado_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        oCatalogoEstadosMgr = New CatalogoEstadosManager(oAppContext)
    End Sub

    Private Sub frmEstado_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
...
#End Region
    ...
    Private Sub frmEstado_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
