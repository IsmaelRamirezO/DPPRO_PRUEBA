...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'menuArchivoEliminar
        '
        Me.menuArchivoEliminar.CommandStyle = Janus.Windows.UI.CommandBars.CommandStyle.Image
        ...
        Me.menuArchivoEliminar.ToolTipText = "Eliminar"
        '
        'LeftRebar1
        '
        ...
        ExplorerBarGroup1.Text = "Datos Generales Tipo Tarjeta"
        Me.ExplorerBar1.Groups.AddRange(New Janus.Windows.ExplorerBar.ExplorerBarGroup() {ExplorerBarGroup1})
        Me.ExplorerBar1.Location = New System.Drawing.Point(0, 48)
        Me.ExplorerBar1.Name = "ExplorerBar1"
        Me.ExplorerBar1.Size = New System.Drawing.Size(408, 176)
...
#Region "Métodos Miembros"
    ...
    Private Function Fm_bolTxtValidar(Optional ByVal Vpa_strOpcion As String = "") As Boolean
        ...
        If (Vpa_strOpcion = "Guardar") Then
            ...
            If (EditBox1.Text.Trim = String.Empty) Then
                MessageBox.Show("Debe especificar un Código de Tipo Tarjeta", "DPTienda", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                EditBox1.Focus()
                Exit Function
            End If
        ...
        If (EditBox2.Text.Trim = String.Empty) Then
            MessageBox.Show("Debe especificar una Descripción de Tipo Tarjeta", "DPTienda", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            EditBox2.Focus()
            Exit Function
        End If
    ...
    Private Sub Sm_Guardar()
        ...
        If (oTipoTarjeta Is Nothing) Then   'Opción Guardar.
            ...
            oTipoTarjeta = oCatalogoTipoTarjetasMgr.Create

            oTipoTarjeta.ID = EditBox1.Text
            oTipoTarjeta.Descripcion = EditBox2.Text
            oTipoTarjeta.Usuario = oAppContext.Security.CurrentUser.Name
            oTipoTarjeta.Fecha = Date.Now
            oTipoTarjeta.Status = True

            oTipoTarjeta.Save()

            oTipoTarjeta = oCatalogoTipoTarjetasMgr.Load(EditBox1.Text)

            EditBox1.Text = oTipoTarjeta.ID
            EditBox2.Text = oTipoTarjeta.Descripcion
        ...
        Else   'Opción Actualizar.
            ...
            Dim Vl_strCodTipoTarjeta As String

            Vl_strCodTipoTarjeta = oTipoTarjeta.ID
            ...
            oTipoTarjeta = Nothing
            oTipoTarjeta = oCatalogoTipoTarjetasMgr.Load(Vl_strCodTipoTarjeta)
    ...
    Private Sub Sm_Eliminar()
        ...
        oCatalogoTipoTarjetasMgr.Delete(oTipoTarjeta.ID)
    ...
    Private Sub Sm_Buscar(Optional ByVal Vpa_bolOpenRecordDialog As Boolean = False)
        ...
        Else
            ...
            oTipoTarjeta = Nothing
            oTipoTarjeta = oCatalogoTipoTarjetasMgr.Load(EditBox1.Text.Trim)
...
#Region "Métodos Privados [Eventos]"
    ...
    Private Sub frmTipoTarjeta_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
...
#End Region
    ...
    Private Sub frmTipoTarjeta_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
