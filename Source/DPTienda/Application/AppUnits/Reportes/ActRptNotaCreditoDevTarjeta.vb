...
Public Class ActRptNotaCreditoDevTarjeta
    Inherits DataDynamics.ActiveReports.ActiveReport
    Dim boolImprimirCedula As Boolean = True

    Public Sub New(ByVal oNC As NotaCredito, Optional ByVal ImprimirCedula As Boolean = True)
        MyBase.New()
        InitializeComponent()
        ...
        oReporteFormapago = New ReporteDetalleFormasPago(oNC.Detalle.Tables(0).Rows(0)("FacturaID"))
        Me.ReporteFormasPago.Report = oReporteFormapago
        Me.ReporteFormasPago.Report.DataSource = oReporteFormapago.DataSource
        Me.ReporteFormasPago.Report.DataMember = oReporteFormapago.DataMember
...
#Region "ActiveReports Designer generated code"
    ...
    Friend WithEvents ReporteFormasPago As DataDynamics.ActiveReports.SubReport
    Private TextBox1 As TextBox = Nothing
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ActRptNotaCreditoDevTarjeta))
        ...
        Me.ReporteFormasPago = New DataDynamics.ActiveReports.SubReport()
        ...
        Me.Label2.Left = 0.2587048!
        Me.Label2.Name = "Label2"
        Me.Label2.Style = "text-align: right; font-weight: normal; font-size: 8.25pt; font-family: Tahoma"
        Me.Label2.Text = "PAGO:"
        Me.Label2.Top = 0.9982237!
        Me.Label2.Width = 0.3937007!
        '
        'ReporteFormasPago
        '
        Me.ReporteFormasPago.CloseBorder = False
        Me.ReporteFormasPago.Height = 0.6924215!
        Me.ReporteFormasPago.Left = 0.7090001!
        Me.ReporteFormasPago.Name = "ReporteFormasPago"
        Me.ReporteFormasPago.Report = Nothing
        Me.ReporteFormasPago.Top = 0.9810001!
        Me.ReporteFormasPago.Width = 1.6875!
        '
        'ActRptNotaCreditoDevTarjeta
        '
