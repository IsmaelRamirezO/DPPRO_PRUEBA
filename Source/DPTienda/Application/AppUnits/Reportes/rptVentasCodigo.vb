...
Public Class rptVentasCodigo
    Inherits DataDynamics.ActiveReports.ActiveReport

    Public Sub New(ByVal TipoReporte As String, ByVal TipoVenta As String, ByVal Marca As String, ByVal Linea As String, ByVal Familia As String, ByVal FechaDe As DateTime, ByVal FechaHasta As DateTime, ByVal OrdenarPor As String)
        MyBase.New()
        InitializeComponent()
        ...
        If TipoReporte.Equals("LineaFam") Then
            ...
            Dim oLinea As Linea
            oLinea = oLineaMgr.Load(Linea)

            LblNombRep.Text = "REPORTE DE ANALIS DE VENTAS LINEA/FAMILIA: " & oLinea.Descripcion & "/" & oFamilias.Descripcion

            Me.DataSource = oAnalisisVentasMgr.GenerarAnalisisVentasLineaFamilia(Linea, Familia, TipoVenta, FechaDe, FechaHasta, OrdenarPor)
        ...
        ElseIf TipoReporte.Equals("MarcaLineaFamilia") Then
            ...
            Dim oMarca As Marca
            oMarca = oMarcaMgr.Load(Marca)

            LblNombRep.Text = "REPORTE DE ANALIS DE VENTAS MARCA/LINEA/FAMILIA: " & oMarca.Descripcion & "/" & oLinea.Descripcion & "/" & oFamilias.Descripcion

            Me.DataSource = oAnalisisVentasMgr.GenerarAnalisisVentasMarcaLineaFamilia(Marca, Linea, Familia, TipoVenta, FechaDe, FechaHasta, OrdenarPor)

        Else
            LblNombRep.Text = "REPORTE DE ANALIS DE VENTAS POR CODIGO"

            Me.DataSource = oAnalisisVentasMgr.GenerarAnalisisVentasCodigo(TipoVenta, FechaDe, FechaHasta, OrdenarPor)
...
#Region "ActiveReports Designer generated code"
	...
	Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptVentasCodigo))
            ...
            Me.TextBox3.Style = "ddo-char-set: 1; text-align: left; font-size: 8pt"
            Me.TextBox3.Top = 0!
            ...
            Me.Line6.Left = 7.317417!
            Me.Line6.LineWeight = 1!
            Me.Line6.Name = "Line6"
            Me.Line6.Top = 0!
            Me.Line6.Width = 0!
            Me.Line6.X1 = 7.317417!
            Me.Line6.X2 = 7.317417!
            Me.Line6.Y1 = 0!
            ...
            Me.Shape4.Top = 0!
            Me.Shape4.Width = 7.3125!
            '
            'TextBox1
            '
            Me.TextBox1.DataField = "PzasTotales"
            Me.TextBox1.Height = 0.2!
            Me.TextBox1.Left = 5.5625!
