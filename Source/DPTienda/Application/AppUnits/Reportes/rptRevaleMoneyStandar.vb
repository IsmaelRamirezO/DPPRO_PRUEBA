...
Public Class rptRevaleMoneyStandar
    Inherits DataDynamics.ActiveReports.ActiveReport

    Dim oFirmaMgr As FirmaManager
    Dim byteFirma As Byte()
    Public Sub New(ByVal DPValeInfo As ControlDPValesWS.DPValeInfo, ByVal Diferencia As Decimal, ByVal oLogo As Bitmap)
        MyBase.New()
        InitializeComponent()
    ...
    Private Sub LoadInfoSAP(ByVal DPValeInfo As ControlDPValesWS.DPValeInfo, ByVal Diferencia As Decimal)
        Try
            ...
            Me.txtCantidad.Text = "$" & CStr(Diferencia)
...
#Region "ActiveReports Designer generated code"
	...
	Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptRevaleMoneyStandar))
            ...
            'PageHeader
            '
            Me.PageHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.pbMarca, Me.Label1, Me.Label2, Me.Label3, Me.barCode, Me.pFirma, Me.Label4, Me.Label5, Me.Label6, Me.Label7, Me.Label8, Me.Label9, Me.Label10, Me.Label11, Me.Label12, Me.txtFolio, Me.txtOrigen, Me.txtFechaExp, Me.txtFechaVigencia, Me.txtClienteAsociado, Me.txtDomicilio, Me.txtTelefono, Me.txtCantidad, Me.txtImporteLetra, Me.txtAsociado, Me.txtFecha, Me.Line1})
            Me.PageHeader.Height = 4.833333!
            ...
            Me.Label12.Top = 2.727854!
            Me.Label12.Width = 1.220472!
            '
            'txtFolio
            '
            Me.txtFolio.Height = 0.2!
            Me.txtFolio.Left = 1.732283!
            ...
            Me.txtFechaExp.Width = 0.7293313!
            '
            'txtFechaVigencia
            '
            Me.txtFechaVigencia.Height = 0.2!
            Me.txtFechaVigencia.Left = 1.456693!
            ...
            Me.txtFechaVigencia.Width = 0.7293313!
            '
            'txtClienteAsociado
            '
            Me.txtClienteAsociado.Height = 0.2!
            Me.txtClienteAsociado.Left = 0.07874014!
