...
Public Class rptVentasCreditoDPVale
    ...
    Public Sub New(ByVal Fecha As DateTime)
        ...
        dsVentasPTVenta = oFacturasMgr.VentasDPValeDelDia(Fecha.Date.ToShortDateString).Copy
        '-----------------------------------------------------------------------------------------------------------------------------------
...
#Region "ActiveReports Designer generated code"
	...
	Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptVentasCreditoDPVale))
            ...
            Me.Label1.Text = "Reporte de Ventas del día Credito DPortenis Vale"
            Me.Label1.Top = 0!
