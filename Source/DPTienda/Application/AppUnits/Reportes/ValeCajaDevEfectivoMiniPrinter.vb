...
Public Class ValeCajaDevEfectivoMiniPrinter
Inherits DataDynamics.ActiveReports.ActiveReport
    ...
    Friend WithEvents tbId As DataDynamics.ActiveReports.TextBox
	...
	Private Sub InitializeComponent()
        ...
        Me.tbId = New DataDynamics.ActiveReports.TextBox()
        ...
        'PageHeader
        '
        Me.PageHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.Label1, Me.tbCliente, Me.Label3, Me.Label2, Me.tbFolio, Me.tbFecha, Me.Label8, Me.tbId})
        ...
        Me.Label8.Text = "ID:"
        Me.Label8.Top = 0.6300001!
        Me.Label8.Width = 0.4375!
        '
        'tbId
        '
        Me.tbId.Height = 0.1875!
        Me.tbId.Left = 0.84!
        Me.tbId.Name = "tbId"
        Me.tbId.Style = "ddo-char-set: 0; font-size: 8.25pt; font-family: Tahoma"
        Me.tbId.Text = "tbId"
        Me.tbId.Top = 0.62!
        Me.tbId.Width = 1.091044!
        '
        'ValeCajaDevEfectivoMiniPrinter
        '
