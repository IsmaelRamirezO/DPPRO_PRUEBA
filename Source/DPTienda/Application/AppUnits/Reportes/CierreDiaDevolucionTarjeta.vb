...
Public Class CierreDiaDevolucionTarjeta
Inherits DataDynamics.ActiveReports.ActiveReport
	...
	Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(CierreDiaDevolucionTarjeta))
        ...
        Me.tbFactOrig.Text = Nothing
        Me.tbFactOrig.Top = 0.0!
        ...
        Me.tbFactAplic.Text = Nothing
        Me.tbFactAplic.Top = 0.0!
        ...
        Me.Label1.Text = "Reporte de Devolución de Tarjetas"
        Me.Label1.Top = 0.0!
...
#Region "Constructores"
    ...
    Public Sub New(ByVal datFechaCierre As Date, ByVal strSucursal As String, ByVal TipoReporte As Boolean)
        ...
        If TipoReporte = False Then
            Me.Label1.Text = "Reporte de Devolución de Efectivo"
        End If

        Sm_CreatDataSet(datFechaCierre, TipoReporte)
...
#Region "Métodos Miembros"
    ...
    Private Sub Sm_CreatDataSet(ByVal datFechaCierre As Date, ByVal EsTarjeta As Boolean)
        ...
        With sccmdDataSet
            ...
            .CommandText = "[CierreDiaReporteDevolucionesTarjetas]"
            ...
            .Parameters.Add(New System.Data.SqlClient.SqlParameter("@EsTarjeta", System.Data.SqlDbType.Bit))
        ...
        Try
            With sccmdDataSet
                ...
                .Parameters("@EsTarjeta").Value = EsTarjeta
    ...
    Private Sub Sm_MostrarInformacion(ByVal datFechaCierre As Date)
        ...
        tbFactOrig.DataField = "Folio"
        tbFactAplic.DataField = "Referencia"
        Me.tbImporte.DataField = "Importe"
        Me.tbSaldo.DataField = "NumeroAutorizacion"
