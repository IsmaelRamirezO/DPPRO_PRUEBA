...
Public Class DevTarjetaEfectivoMiniPrinter
...
#Region "Members Variables"
    ...
    Private Datos As Dictionary(Of String, Object)
...
#Region "Constructors"
    ...
    Public Sub New(ByVal Datos As Dictionary(Of String, Object))
        MyBase.New()
        InitializeComponent()
        Me.Datos = Datos
...
#Region "Methods"
    ...
    Private Sub Sm_MostrarInformacion()
        Me.tbFolio.Text = CStr(Datos("Referencia"))
        Me.tbFecha.Text = Format(CDate(Datos("Fecha")), "dd - MMM - yyyy")
        Me.tbCliente.Text = CStr(Datos("Cliente"))
        Me.tbDocumentoFolio.Text = CStr(Datos("Referencia"))
        Me.tbDocumentoImporte.Text = Format(CDec(Datos("Importe")), "Currency")
        Dim Cantidad() As String = CStr(Datos("Importe")).Split(".")
