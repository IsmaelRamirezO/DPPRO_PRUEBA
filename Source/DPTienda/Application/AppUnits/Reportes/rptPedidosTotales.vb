...
Public Class rptPedidosTotales
...
#Region "ActiveReports Designer generated code"
	...
	Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptPedidosTotales))
        ...
        'ReportHeader
        '
        Me.ReportHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.lblDe, Me.lblCaja, Me.lblFecha, Me.txtFecha, Me.txtCaja, Me.lblSucursal, Me.lblReportTitle, Me.txtFechaDe, Me.lblFechaAl, Me.txtFechaAl, Me.txtSucursal, Me.Shape1})
    ...
    "ical-align: middle"
        Me.lblReportTitle.Text = "Reporte de Pedidos Facturados Si Hay Totales"
    ...
    "8.25pt; font-family: Arial"
        ...
        'Shape3
        '
        Me.Shape3.Height = 0.188!
        Me.Shape3.Left = 0.0!
        Me.Shape3.LineWeight = 2.0!
        Me.Shape3.Name = "Shape3"
        Me.Shape3.RoundingRadius = 9.999999!
        Me.Shape3.Top = 0.0!
        Me.Shape3.Width = 7.0625!
        '
        'GroupHeader1
        '
        Me.GroupHeader1.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.lblFolio, Me.lblFolioSAP, Me.lblFieldFecha, Me.lblTotalArt, Me.lblImporte, Me.lblDescuento, Me.lblFormaPago, Me.lblPago, Me.lblVendedor, Me.lblCliente, Me.lblTipoVenta, Me.lblStatus})
        ...
        Me.lblFolioSAP.Text = "Referencia"
        ...
        If Not Me.dtPedidos Is Nothing Then
            If Not tbFolio.Text Is Nothing Then
                If Not tbFolio.Text = String.Empty Then
                    ...
                    oRow = Me.dtPedidos.Select("Referencia ='" & txtFolioSAP.Text & "'", "Folio", DataViewRowState.CurrentRows)
                    If Not oRow Is Nothing Then
                        oReporteFormapago = New ReporteDetalleFormasPago(oRow(0).Item("PedidoID"), 2) '(oDataRpt.FacturaID)
