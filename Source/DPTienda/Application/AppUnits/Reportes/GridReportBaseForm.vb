Public Class GridReportBaseForm
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(GridReportBaseForm))
        ...
        Me.geResults.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.Name = "GridReportBaseForm"
        Me.Text = "Grid Report Base Form"
...
#End Region
    ...
    Protected Friend Overridable Sub ActionExport()
        MsgBox("GridReportBaseForm.ActionExport")
    End Sub

    Protected Friend Overridable Sub ActionPrint()
        MsgBox("GridReportBaseForm.ActionPrint")
    End Sub

    Protected Friend Overridable Sub ActionPreview()
        MsgBox("GridReportBaseForm.ActionPreview")
    End Sub

    Protected Friend Overridable Sub ActionGenerate()
        MsgBox("GridReportBaseForm.ActionGenerate")
    End Sub
