...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        ExplorerBarGroup1.Text = "Histórico de Apartados"
        ...
        Me.Text = "Consulta General de Movimientos de Apartados por Artículo"
...
#Region "Private Methods"
    ...
    Public Sub Sm_ActionPrint()
        ...
        If (dtDetalle.Rows.Count = 0) Then
            ...
            MsgBox("El Artículo no cuenta con Apartados.", MsgBoxStyle.Exclamation, "DPTienda")
            ebCodigo.Focus()
            Exit Sub
        ...
        oARReporte.Document.Name = "Histórico de Artículos Apartados"
        oARReporte.Run()
