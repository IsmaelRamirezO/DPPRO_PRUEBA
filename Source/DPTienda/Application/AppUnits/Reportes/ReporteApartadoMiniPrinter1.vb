...
Public Class ReporteApartadoMiniPrinter
    ...
    Public Sub New(ByVal oForm As frmContratos, ByVal oFormClientes As ClienteAlterno, ByVal strDocFi As String, ByVal Detalle As DataTable, Optional ByVal Reimpresion As Boolean = False)
        MyBase.New()
        InitializeComponent()
...
#Region "ActiveReports Designer generated code"
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ReporteApartadoMiniPrinter))
    ...
    "los tribunales radicados en la ciudad de Mazatlán, Sinaloa."
        ...
        Me.PageHeader.Height = 3.135417!
        Me.PageHeader.Name = "PageHeader"
        '
        'tbFolio
        '
        Me.tbFolio.Height = 0.1761812!
        Me.tbFolio.Left = 0.2559055!
