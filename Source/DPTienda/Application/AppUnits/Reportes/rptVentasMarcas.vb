...
Public Class rptVentasMarcas
    ...
    Public Sub New(ByVal TipoVenta As String, ByVal FechaDe As DateTime, ByVal FechaHasta As DateTime, ByVal OrdenarPor As String)
        ...
        Me.DataSource = oAnalisisVentasMgr.GenerarAnalisisVentasMarcas(TipoVenta, FechaDe, FechaHasta, OrdenarPor)
        Me.Run()
...
#Region "ActiveReports Designer generated code"
	...
	Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptVentasMarcas))
            ...
            Me.Label1.Text = "ANALISIS DE VENTAS POR MARCAS"
