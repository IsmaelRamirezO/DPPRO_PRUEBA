...
Public Class rptAbonosContratosAll
Inherits DataDynamics.ActiveReports.ActiveReport
    Public Sub New(ByVal dsDetalle As DataSet, ByVal FechaDe As DateTime, ByVal FechaAl As DateTime, ByVal caja As String)
        ...
        oAlmacen = oAlmacenesMgr.Load(oAppContext.ApplicationConfiguration.Almacen)
        ...
        Dim result As Object = dsDetalle.Tables(0).Compute("sum(Abono)", "StatusRegistro like 'N'")

        If Not result Is DBNull.Value Then
            Abono = dsDetalle.Tables(0).Compute("sum(Abono)", "StatusRegistro like 'N'")
        End If

        Dim result2 As Object = dsDetalle.Tables(0).Compute("sum(SaldoNuevo)", "StatusRegistro like 'N'")

        If Not result2 Is DBNull.Value Then
            Saldo = dsDetalle.Tables(0).Compute("sum(SaldoNuevo)", "StatusRegistro like 'N'")
        End If


        If CStr(Abono).IndexOf(".") > 0 Then
            Me.txtImporteGT.Text = "$" & CStr(Abono).Substring(0, CStr(Abono).IndexOf(".") + 3)
        Else
            Me.txtImporteGT.Text = "$" & CStr(Abono)
        End If

        If CStr(Saldo).IndexOf(".") > 0 Then
            Me.txtSaldoGT.Text = "$" & CStr(Saldo).Substring(0, CStr(Saldo).IndexOf(".") + 3)
        Else
            Me.txtSaldoGT.Text = "$" & CStr(Saldo)
        End If
...
#Region "ActiveReports Designer generated code"
	...
	Private txtCancelado As TextBox = Nothing
	...
	Private Sub InitializeComponent()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptAbonosContratosAll))
            ...
            Me.txtCancelado = New DataDynamics.ActiveReports.TextBox()
            ...
            CType(Me.txtCancelado,System.ComponentModel.ISupportInitialize).BeginInit
            ...
            Me.Detail.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txtFolioAbono, Me.txtFolioApartado, Me.txtPlayer, Me.txtFormaPago, Me.txtImporte, Me.txtSaldo, Me.txtCancelado, Me.txtFechaAbono, Me.Line4, Me.Line5})
            Me.Detail.Height = 0.1979167!
            Me.Detail.Name = "Detail"
            '
            'PageHeader
            '
            Me.PageHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.Shape1, Me.Label9, Me.Label7, Me.Label6, Me.Label5, Me.Label4, Me.Label3, Me.Label11, Me.Label1, Me.Label12, Me.Label2, Me.txtFechaDel, Me.Label13, Me.txtSucursal, Me.Label14, Me.txtFechaAl, Me.txtFecha, Me.txtCaja, Me.Line1, Me.TextBox10, Me.TextBox11, Me.Label16})
            Me.PageHeader.Height = 1.025694!
            ...
            Me.Label11.Left = 6.444882!
            Me.Label11.Name = "Label11"
            Me.Label11.Style = "text-align: center; font-weight: normal; font-size: 8.25pt"
            Me.Label11.Text = "CANCELADO"
            Me.Label11.Top = 0.7642716!
            Me.Label11.Width = 0.7711618!
            '
            'Label1
            '
            ...
            Me.Label1.Style = ""
            Me.Label1.Text = "REPORTE DE ABONOS Y ANTICIPOS"
            ...
            Me.Line1.Width = 7.283465!
            Me.Line1.X1 = 7.283465!
            Me.Line1.X2 = 0!
            ...
            'txtCancelado
            '
            Me.txtCancelado.DataField = "StatusRegistro"
            Me.txtCancelado.Height = 0.2!
            Me.txtCancelado.Left = 6.5!
            Me.txtCancelado.Name = "txtCancelado"
            Me.txtCancelado.Style = "text-align: center; font-size: 9pt"
            Me.txtCancelado.Top = 0!
            Me.txtCancelado.Width = 0.7322834!
            '
            'txtFechaAbono
            '
            ...
            Me.txtFechaAbono.Width = 0.6048228!
            '
            'Line4
            '
            Me.Line4.Height = 0.1968504!
            Me.Line4.Left = 7.283465!
            Me.Line4.LineWeight = 1!
            Me.Line4.Name = "Line4"
            Me.Line4.Top = 0!
            Me.Line4.Width = 0!
            Me.Line4.X1 = 7.283465!
            Me.Line4.X2 = 7.283465!
            Me.Line4.Y1 = 0!
            Me.Line4.Y2 = 0.1968504!
            '
            'Line5
            '
            Me.Line5.Height = 0.1968504!
            Me.Line5.Left = 0.00694466!
            Me.Line5.LineWeight = 1!
            Me.Line5.Name = "Line5"
            Me.Line5.Top = 0!
            Me.Line5.Width = 0!
            Me.Line5.X1 = 0.00694466!
            Me.Line5.X2 = 0.00694466!
            Me.Line5.Y1 = 0!
            Me.Line5.Y2 = 0.1968504!
            '
            'Shape2
            '
            ...
            Me.txtImportePagina.Left = 4.437008!
            ...
            Me.txtSaldoPagina.Left = 5.385417!
            ...
            CType(Me.txtCancelado,System.ComponentModel.ISupportInitialize).EndInit
...
#End Region
    ...
    Private Abonos = 0, Saldos = 0, Pagina As Decimal = 0

    Private Sub Detail_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles Detail.Format

        If DirectCast(Detail.Controls("txtCancelado"), TextBox).Text = "N" Then

            Saldos += CDec(DirectCast(Detail.Controls("txtImporte"), TextBox).Text.Trim("$"))
            Abonos += CDec(DirectCast(Detail.Controls("txtSaldo"), TextBox).Text.Trim("$"))
    ...
    Private Sub rptAbonosContratosAll_PageStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PageStart
    ...
    Private Sub PageFooter_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles PageFooter.Format
        ...
        DirectCast(Me.PageFooter.Controls("txtImportePagina"), TextBox).Text = "$" & Saldos
        DirectCast(Me.PageFooter.Controls("txtSaldoPagina"), TextBox).Text = "$" & Abonos

    End Sub

    Private Sub rptAbonosContratosAll_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ReportStart
