...
Public Class PedidosTotales
    ...
    Public Sub New(ByVal datFechaInicio As Date, ByVal datFechaFin As Date)
        MyBase.New()
        InitializeComponent()
        'Encabezado :
        Dim ReporteVenta As New ReporteVentasDataGateWay(oAppContext.ApplicationConfiguration.DataStorageConfiguration.GetConnectionString(), oAppContext)
        Dim ds As DataSet
        ...
        oAlmacen = Nothing
        ds = ReporteVenta.GetReportePedido(datFechaInicio, datFechaFin, oAppContext.ApplicationConfiguration.NoCaja, oAppContext.ApplicationConfiguration.Almacen)
...
#Region "ActiveReports Designer generated code"
	...
	Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(PedidosTotales))
        ...
        Me.Detail.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.tbFolio, Me.txtFolioSAP, Me.tbFecha, Me.tbArticulo, Me.tbImporte, Me.tbdescuento, Me.SubReport1, Me.tbVendedor, Me.tbCliente, Me.tbTipoVenta, Me.tbNcred, Me.txtCodCaja})
        ...
        'PageHeader
        '
        Me.PageHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.Shape1, Me.lblReportTitle, Me.LblFechaAL, Me.LblFechaDE, Me.LblSucursal, Me.Label5, Me.LblCaja, Me.Label4, Me.Label1, Me.LblFecha})
        Me.PageHeader.Height = 0.625!
    ...
    "ical-align: middle"
        Me.lblReportTitle.Text = "Reporte de Total de Pedidos"
    ...
    "8.25pt; font-family: Arial"
        ...
        'PageFooter
        '
        Me.PageFooter.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.tbTotalImporte, Me.tbTotalArticulos, Me.tbTotalFact, Me.Shape3})
        ...
        'GroupHeader1
        '
        Me.GroupHeader1.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.lblFieldFolio, Me.Label7, Me.Label6, Me.lblFieldArticulo, Me.lblFieldImporte, Me.lblFieldDescuento, Me.lblFieldFormaPago, Me.lblFieldPago, Me.lblFieldVendedor, Me.lblFieldCliente, Me.lblFieldTipoVenta, Me.lblFieldNCred, Me.Shape4})
        ...
        If Not Me.dtFacturas Is Nothing Then
            If Not tbFolio.Text Is Nothing Then
                If Not tbFolio.Text = String.Empty Then
                    oRow = Me.dtFacturas.Select("FolioSAP ='" & txtFolioSAP.Text & "' and CodCaja ='" & Me.txtCodCaja.Text & "'", "Folio", DataViewRowState.CurrentRows)
                    If Not oRow Is Nothing Then
                        oReporteFormapago = New ReporteDetalleFormasPago(oRow(0).Item("PedidoID"), 1)
