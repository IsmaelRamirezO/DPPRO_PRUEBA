...
Public Class OpenFROMSAPRecordDialogClientesDPVale
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OpenFROMSAPRecordDialogClientesDPVale))
    ...
    "re una columna para agrupar</GroupByBoxInfo></LocalizableData>"
        ...
        '
        'OpenFROMSAPRecordDialogClientesDPVale
        '
        ...
        Me.Name = "OpenFROMSAPRecordDialogClientesDPVale"
...
#End Region
    ...
    Dim oCurrentView As IOpenFromSAPRecordDialogViewClientesDPVale
    ...
    Public Property TipoVenta() As String
        ...
        Set(ByVal Value As String)
            ...
            If Value = "K" OrElse Value = "F" OrElse Value = "O" Then

                Me.GrupoDeCuentas = "D019"

            ElseIf Value = "I" OrElse Value = "A" Then

                Me.GrupoDeCuentas = "D018"

            ElseIf Value = "D" Then

                Me.GrupoDeCuentas = "D002"
    ...
    Public Property CurrentView() As IOpenFromSAPRecordDialogViewClientesDPVale
        Get
            Return oCurrentView
        End Get

        Set(ByVal Value As IOpenFromSAPRecordDialogViewClientesDPVale)
            ...
            oCurrentView.SetupDataBinding(GridEX1, frmClientesFiltroSAP.Criterio, Me.GrupoDeCuentas, oConfigCierreFI.AplicarS2Credit)
