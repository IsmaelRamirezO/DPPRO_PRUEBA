...
Public Class CatalogoBancosOpenRecordDialogView
...
#Region "Private Methods"
    ...
    Public Sub SetupDataBinding(ByVal TargetGridEx As Janus.Windows.GridEX.GridEX) Implements IOpenRecordDialogView.SetupDataBinding
        ...
        dsDataSource = oCatalogoBancoMgr.GetAll(False)

        With TargetGridEx

            .SetDataBinding(dsDataSource, "CatalogoBancos")
            .RetrieveStructure()
        End With
    ...
    Public Sub SetupView(ByVal TargetGridEx As Janus.Windows.GridEX.GridEX) Implements IOpenRecordDialogView.SetupView
        ...
        With TargetGridEx.Tables("CatalogoBancos")

            .Columns("CodBanco").Caption = "Código"
