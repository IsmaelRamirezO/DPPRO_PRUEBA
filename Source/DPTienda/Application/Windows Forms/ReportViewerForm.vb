...
Public Class ReportViewerForm
    ...
    Private m_bBanImagen As Boolean = False

    Private m_arReport As ActiveReport
    'Dim oInicioDiaMgr As New InicioDiaManager(oAppContext, oAppSAPConfig)
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents FileOpenCommand As Janus.Windows.UI.CommandBars.UICommand
    Friend WithEvents FileSaveCommand As Janus.Windows.UI.CommandBars.UICommand
    ...
    Friend WithEvents FileOpenCommand1 As Janus.Windows.UI.CommandBars.UICommand
    Friend WithEvents FileSaveCommand1 As Janus.Windows.UI.CommandBars.UICommand
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ReportViewerForm))
        ...
        Me.FileOpenCommand1 = New Janus.Windows.UI.CommandBars.UICommand("FileOpenCommand")
        Me.FileSaveCommand1 = New Janus.Windows.UI.CommandBars.UICommand("FileSaveCommand")
        ...
        Me.FileOpenCommand = New Janus.Windows.UI.CommandBars.UICommand("FileOpenCommand")
        Me.FileSaveCommand = New Janus.Windows.UI.CommandBars.UICommand("FileSaveCommand")
        ...
        CType(Me.EnvironmentManager.EditContextMenu, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.EnvironmentManager.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.FileMenu, Me.FileOpenCommand, Me.FileSaveCommand, Me.FileExportMenu, Me.FileCloseCommand, Me.ViewMenu, Me.Imprimir, Me.ImprimirPartes})
        ...
        Me.EnvironmentMenuesBar.Size = New System.Drawing.Size(848, 24)
        Me.EnvironmentMenuesBar.TabIndex = 0
        ...
        Me.EnvironmentStandardBar.Location = New System.Drawing.Point(0, 24)
        ...
        Me.EnvironmentStandardBar.Size = New System.Drawing.Size(397, 26)
        Me.EnvironmentStandardBar.TabIndex = 1
        ...
        Me.FileMenu.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.FileOpenCommand1, Me.FileSaveCommand1, Me.Separator1, Me.FileExportMenu1, Me.Separator2, Me.FileCloseCommand1})
        ...
        'FileOpenCommand1
        '
        Me.FileOpenCommand1.Key = "FileOpenCommand"
        Me.FileOpenCommand1.Name = "FileOpenCommand1"
        '
        'FileSaveCommand1
        '
        Me.FileSaveCommand1.Key = "FileSaveCommand"
        Me.FileSaveCommand1.Name = "FileSaveCommand1"
        '
        'Separator1
        '
        ...
        'FileOpenCommand
        '
        Me.FileOpenCommand.CategoryName = "Archivo"
        Me.FileOpenCommand.Key = "FileOpenCommand"
        Me.FileOpenCommand.Name = "FileOpenCommand"
        Me.FileOpenCommand.Text = "&Abrir"
        '
        'FileSaveCommand
        '
        Me.FileSaveCommand.CategoryName = "Archivo"
        Me.FileSaveCommand.Key = "FileSaveCommand"
        Me.FileSaveCommand.Name = "FileSaveCommand"
        Me.FileSaveCommand.Text = "&Guardar"
        '
        'FileExportMenu
        '
        ...
        CType(Me.EnvironmentManager.EditContextMenu, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub EnvironmentManager_CommandClick(ByVal sender As Object, ByVal e As Janus.Windows.UI.CommandBars.CommandEventArgs) Handles EnvironmentManager.CommandClick
        ...
        Select Case e.Command.Key
            ...
            Case FileOpenCommand.Key

                ActionOpenFile()

            Case FileSaveCommand.Key
            ...
            Case FileExportMenu.Key
                If BanImagen = False Then
                    ActionExportFile()
                Else
                    MsgBox("¡La exportacion está deshabilitada con imagenes!", MsgBoxStyle.Information, Me.Text)
                End If
    ...
    Public Sub ActionOpenFile()

        Dim oOpenFileDialog As New OpenFileDialog

        With oOpenFileDialog
            .Title = "Abrir reporte"
            .Filter = "Archivos de Reporte (*.arf)|*.arf|Todos los archivos (*.*)|*.*"
        End With
        ...
        If (oOpenFileDialog.ShowDialog = DialogResult.OK) Then
            ...
            Try
                ...
                Viewer1.Document.Load(oOpenFileDialog.FileName)

                If (Viewer1.Document.Name <> "ActiveReport Document") Then

                    Me.Text = "Vista preliminar - " & Viewer1.Document.Name

                End If

            Catch ex As Exception

                MsgBox("Ocurrio un error al intentar cargar el archivo seleccionado.")
    ...
    Public Sub ActionSaveFile()
        ...
        If (oSaveFileDialog.ShowDialog = DialogResult.OK) Then
            ...
            Try
                ...
                Viewer1.Document.Save(oSaveFileDialog.FileName, Document.RdfFormat.ARNet)

            Catch ex As Exception

                MsgBox("Ocurrio un error al intentar guardar el reporte.")
    ...
    Public Property BanImagen() As Boolean
        Get
            Return m_bBanImagen
        End Get
