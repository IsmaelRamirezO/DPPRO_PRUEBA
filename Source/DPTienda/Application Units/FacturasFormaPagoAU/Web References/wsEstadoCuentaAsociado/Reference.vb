...
'
Namespace wsEstadoCuentaAsociado
    ...
    Partial Public Class EstadodeCuentaAsociado
        ...
        Public Sub New()
            MyBase.New
            'Me.Url = Global.DportenisPro.DPTienda.ApplicationUnits.FacturasFormaPago.My.MySettings.Default.FacturasFormaPagoAU_wsEstadoCuentaAsociado_EstadodeCuentaAsociado
            strURL = "Credito/EstadodeCuentaAsociado.asmx"
            Dim urlSetting As String = System.Configuration.ConfigurationManager.AppSettings("FacturasFormaPagoAU.wsEstadoCuentaAsociado.EstadodeCuentaAsociado")
