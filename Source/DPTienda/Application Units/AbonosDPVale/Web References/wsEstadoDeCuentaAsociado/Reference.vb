...
Namespace wsEstadoDeCuentaAsociado
    ...
    Partial Public Class EstadodeCuentaAsociado
        ...
        Public Sub New()
            MyBase.New()
            'Me.Url = Global.DportenisPro.DPTienda.ApplicationUnits.AbonosDPVale.My.MySettings.Default.AbonosDPVale_wsEstadoDeCuentaAsociado_EstadodeCuentaAsociado
            strURL = "Credito/EstadodeCuentaAsociado.asmx"
            Dim urlSetting As String = System.Configuration.ConfigurationManager.AppSettings("AbonosDPVale.wsEstadoDeCuentaAsociado.EstadodeCuentaAsociado")
