...
Namespace wsEstadoCuentaAsociado
    ...
    Partial Public Class EstadodeCuentaAsociado
        ...
        Public Sub New()
            MyBase.New
            'Me.Url = Global.DportenisPro.DPTienda.ApplicationUnits.NotasCreditoAU.My.MySettings.Default.NotasCreditoAU_wsEstadoCuentaAsociado_EstadodeCuentaAsociado
