...
#Region "Fields"
    ...
    Private m_intPromo As Integer
    Private m_strDescripcion As String
    Private m_strAbrevPromo As String
    ...
    Public Property AbrevPromo() As String
        Get
            Return m_strAbrevPromo
        End Get
        Set(ByVal Value As String)
            m_strAbrevPromo = Value
        End Set
    End Property
